...
/*package*/ class AppScanStats {
        ...
        if (scan != null) {
            ...
            if (scan.results % 100 == 0) {
                try {
                    ...
                    Log.i(TAG, "BLE_SCAN_RESULT_RECEIVED["+scannerId+"]noteBleScanResults=" + scan.results);
                } catch (RemoteException e) {
                    /* ignore */
                    Log.e(TAG, "ERROR: ["+scannerId+"]noteBleScanResults=" + scan.results);
                }
    ...
    synchronized void recordScanStart(ScanSettings settings, boolean filtered, int scannerId) {
        ...
        try {
            ...
            Log.i(TAG, "BLE_SCAN_STATE_CHANGED["+scannerId+"]noteBleScanStarted=" + isUnoptimized);
        } catch (RemoteException e) {
            /* ignore */
            Log.e(TAG, "ERROR: ["+scannerId+"]noteBleScanStarted");
        }
    ...
    synchronized void recordScanStop(int scannerId) {
        ...
        try {
            ...
            Log.i(TAG, "BLE_SCAN_STATE_CHANGED["+scannerId+"]noteBleScanStopped=" + isUnoptimized);
        } catch (RemoteException e) {
            /* ignore */
            Log.e(TAG, "ERROR: ["+scannerId+"]noteBleScanResults=" + scan.results);
            Log.e(TAG, "ERROR: ["+scannerId+"]noteBleScanStopped");
        }

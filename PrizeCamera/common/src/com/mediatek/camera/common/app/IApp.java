...
public interface IApp {
    ...
    /**
     * set the value of cameramute setting
     * @param value
     */
    void setCameraMuteValue(String value);

    /**
     * get the value of cameramute setting
     * @return
     */
     ...
     * @return
     */
    String getSettingValue(String key,String defaultvalue,int cameraid);

    /**
     * add for xiaoping 20181123 get ModeManger
     * @return
     */
    ModeManager getModeManger();

    /*prize-modify-increase external storage-xiaoping-20190111-start*/
    Uri  creteDocumenFile(String displayname,String mintype);

    String getCameraDirectorySD();

    boolean isExtranelStorageMount();

    boolean isHasPermissionForSD();
    ...
    void  registerOnTouchListener(OnTouchListener listener);
    /*prize-add-huangpengfei-2019-02-28-end*/

    /**
     * add for Determine if it is currently in a low battery state -xiaoping-20190306
     * @return
     */
    boolean isBatteryLow();

    /*prize-add-huangpengfei-2019-03-15-start*/
    interface OnBatteryLowListener {
        void onBatteryLow();
    }
    void  unregisterBatteryLowListener(OnBatteryLowListener listener);

    void  registerOnBatteryLowListener(OnBatteryLowListener listener);

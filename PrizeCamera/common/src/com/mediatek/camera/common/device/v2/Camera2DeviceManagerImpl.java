        ...
        private class RespondCameraHandler extends Handler {
                    ...
                    case MSG_CLOSE_CAMERA:
                        ...
                        if(mCamera2Proxy != null && mCameraDevice != null) {
                            ...
                            if ("1".equals(mCameraId)) {
                                mApp.getAppUi().getLifaCamera().updateLiftCameraState(IAppUi.LiftCamera.LiftCameraState.START_DOWN);
                            }
                            /*prize-modify-add front lift camera interaction-xiaoping-20190304-end*/
            ...
            private void openCamera() {
                try {
                    ...
                    /*prize-modify-add front lift camera interaction-xiaoping-20190304-start*/
                    if (mApp.getAppUi() != null && mApp.getAppUi().getLifaCamera() != null) {
                        if ("1".equals(mCameraId)) {
                            mApp.getAppUi().getLifaCamera().updateLiftCameraState(IAppUi.LiftCamera.LiftCameraState.START_UP);
                        }
                    }
                    /*prize-modify-add front lift camera interaction-xiaoping-20190304-end*/

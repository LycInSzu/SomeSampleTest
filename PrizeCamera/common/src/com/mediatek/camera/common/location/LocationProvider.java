...
public class LocationProvider {
    ...
    /*prize-modif-add location info-xiaoping-20181221-start*/
    public LocationProvider(Context context, IApp app) {
        mContext = context;
        mLocationPermission = new PermissionManager((Activity) context);
        mApp = app;
    }
    /*prize-modif-add location info-xiaoping-20181221-end*/
    ...
    public Location getCurrentLocation() {
        /*prize-modif-add location info-xiaoping-20181221-start*/
        if (!mRecordLocation || "off".equals(mApp.getSettingValue("key_location","on",mApp.getAppUi().getCameraId()))) {
            return null;
        }
        /*prize-modif-add location info-xiaoping-20181221-end*/

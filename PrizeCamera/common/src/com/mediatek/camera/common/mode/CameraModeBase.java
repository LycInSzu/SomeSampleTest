...
import android.content.Intent;   // intent  for gts 
...
public abstract class CameraModeBase implements
    ...
    protected boolean needCloseCameraSync() {
        ...
        if (mNextModeDeviceUsage == null) {
            ...
            boolean isLowNight = DeviceUsage.DEVICE_TYPE_LOWNIGHT.equals(currentType); // zhangguo add for lownight
            return isStereo || isVsdof || isLowNight;
        }

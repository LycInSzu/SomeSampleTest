...
public class DeviceUsage {
    ...
    public static final String DEVICE_TYPE_LOWNIGHT = "lownight"; // zhangguo add for lowlight
    ...
    public ArrayList<String> getNeedClosedCameraIds(@Nullable DeviceUsage newModeDeviceUsage) {
        ...
        for (int i = 0; i < needClosedCameraIds.size(); i++) {
            LogHelper.i("","newModeDeviceUsage: "+newModeDeviceUsage.getCameraIdList()+",needClosedCameraIds.get(i): "+needClosedCameraIds.get(i));
    ...
    /*prize-modify-bugid:72030-duplicate opencamera will appear in proactive switching mode-xiaoping-20190308-start*/
    public void updateNeedCloseCameraId(List<String> cameraIdList) {
        mNeedOpenedCameraIdList =  new ArrayList<>(cameraIdList);
    }
    /*prize-modify-bugid:72030-duplicate opencamera will appear in proactive switching mode-xiaoping-20190308-end*/
}
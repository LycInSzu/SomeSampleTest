...
public class PhotoMode extends CameraModeBase implements CaptureDataCallback,
    ...
    protected void initDeviceController(){
        ...
        mIDeviceController = deviceControllerFactory.createDeviceController(mIApp,
    ...
    public void resume(@Nonnull DeviceUsage deviceUsage) {
        ...
        isTakePicture = false; // add by zhangugo for bug#74523 capture status is error
    }
    ...
    public void pause(@Nullable DeviceUsage nextModeDeviceUsage) {
        ...
        // add by zhangugo for bug#74523 capture status is error begin
        mModeHandler.removeMessages(SCREEN_FLASH_TAKE_PICTRE);
        mModeHandler.removeMessages(SCREEN_FLASH_VIEW_HIDE);
        // add by zhangugo for bug#74523 capture status is error end
...
/*                HeifHelper heifHelper = new HeifHelper(mICameraContext);
    ...
    protected void prepareAndOpenCamera(boolean needOpenCameraSync, String cameraId,
        ...
        statusMonitor.registerValueChangedListener(KEY_PICSELFIE, mStatusChangeListener); // zhangguo add for picselfie
        /*prize-add-screen flash-huangzhanbin-20190226-start*/
    ...
    private void clearAllCallbacks(String cameraId) {
        ...
        statusMonitor.unregisterValueChangedListener(KEY_PICSELFIE, mStatusChangeListener); // zhangguo add for picselfie

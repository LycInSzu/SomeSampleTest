...
public class VideoRestriction {
        ...
        if (SystemProperties.getInt("vendor.mtk.camera.app.fd.video", 0) == 0) {
            ...
            sPreviewRelationGroup.addRelation(
                    new Relation.Builder(VIDEO_MODE_KEY, "preview")
                            ...
                            //.addBody("key_face_detection", "off", "off") // prize del by zhangguo, for facedetection in video mode
                            .build());
        } else {
    ...
    static {
        ...
        /*prize-modify-bugid:70348-xiaoping-20190105-start*/
/*        if (SystemProperties.getInt("vendor.mtk.camera.app.fd.video", 0) == 0) {
        ...
        /*prize-modify-bugid:70348-xiaoping-20190105-end*/
        sRecordingRelationGroupForMode.addRelation(

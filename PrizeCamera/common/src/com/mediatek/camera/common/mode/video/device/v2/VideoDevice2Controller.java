...
public class VideoDevice2Controller extends Device2Controller
    ...
    private void initProfile() {
        ...
        /*prize-modify-bugid:70264 set the preview resolution of the third-party app to call the camera video-xiaoping-20181229-start*/
        if (isCaptureByIntent()) {
            quality = 5;
        }
        /*prize-modify-bugid:70264 set the preview resolution of the third-party app to call the camera video-xiaoping-20181229-end*/

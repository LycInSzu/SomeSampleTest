    ...
    private IDeviceController.DeviceCallback mPreviewStartCallback = new
            IDeviceController.DeviceCallback() {
                ...
                public void onPreviewStart() {
                    /*prize-modify-bug the pause button in the video section overlaps the preview key-xiaoping-20190415-start*/
                    mAppUi.setUIVisibility(IAppUi.THUMBNAIL,View.GONE);
                    /*prize-modify-bug the pause button in the video section overlaps the preview key-xiaoping-20190415-end*/

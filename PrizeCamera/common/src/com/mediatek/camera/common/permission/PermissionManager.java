...
public class PermissionManager {
    ...
    public boolean isCameraLaunchPermissionsResultReady(
        ...
        perms.put(Manifest.permission.READ_EXTERNAL_STORAGE,
                PackageManager.PERMISSION_GRANTED);
        /*prize-add fixbug:[70732]-huangpengfei-2019-01-14-start*/
        for (int i = 0; i < permissions.length; i++) {
            LogHelper.d(TAG, "[isCameraLaunchPermissionsResultReady] permissions = "+permissions[i]+"  grantResults = "+grantResults[i]);
        ...
        return false;*/
        /*prize-add fixbug:[70732]-huangpengfei-2019-01-14-end*/
    }
    ...
    private void initCameraLaunchPermissionList() {
        ...
        /*prize-modify-add for permissions required to increase location information-xiaoping-20181227-start*/
        mLaunchPermissionList.add(Manifest.permission.ACCESS_COARSE_LOCATION);
        mLaunchPermissionList.add(Manifest.permission.ACCESS_FINE_LOCATION);
        /*prize-modify-add for permissions required to increase location information-xiaoping-20181227-end*/
    }

...
import com.mediatek.camera.feature.setting.ai.Ai;//prize-add AI CAMERA-huangpengfei-20190110
...
public class SettingManager implements ISettingManager,
    ...
    private CameraCharacteristics mCharacteristics;//prize-add-huangpengfei-2018-11-2
    ...
    public void setCameraCharacteristics(CameraCharacteristics characteristics) {
        ...
        mCharacteristics = characteristics;//prize-add-huangpengfei-2018-11-2
        List<ICameraSetting> settings = getSettingByModeType(mModeType);
    ...
    public void reset(){
        ...
        for (ICameraSetting setting : settings) {
            ...
            if (setting instanceof PrizeDataRevert){
                ((PrizeDataRevert)setting).clearCache();
            }
            if (requestConfigure != null){
                requestConfigure.setCameraCharacteristics(mCharacteristics);
            }
            setting.refreshViewEntry();
        }
    }
    ...
    @Override
    public void setAiSceneId(int sceneId){
        ICameraSetting setting = mSettingTable.get(Ai.AI_KEY);
        if (setting instanceof Ai){
            ((Ai)setting).updateAiSenceIcon(sceneId);
        }
    }

...
public class CoordinatesTransform {
    ...
    public static Rect uiToSensor(Point p,
        ...
        if (characteristics != null && characteristics.get(CameraCharacteristics.LENS_FACING)
                == CameraCharacteristics.LENS_FACING_FRONT) {
            points[0] = 1 - points[0];
        }
        /*prize-modify-huangpengfei-2018-12-28-start*/
        int sensorOrientation = 0;
        if (characteristics != null){
            sensorOrientation = characteristics.get(
                    CameraCharacteristics.SENSOR_ORIENTATION);
        }
        /*prize-modify-huangpengfei-2018-12-28-end*/

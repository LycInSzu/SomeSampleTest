...
//import com.mediatek.camera.common.R;
...
public class PreviewFrameLayout extends FrameLayout {
    ...
    private double mRadio = 0.00d;
    private int mScreenPixHeight;
    /*prize-modify-bugid:67064 adjust the position of the focus area-xiaoping-20181102-end*/
    private int mShutterGroupHeight;//prize-add-huangpengfei-2018-12-24

    /*prize-modify-get the bottomMargin and radio-xiaoping-20190214-start*/
    private int mPreviewBottomMargin;
    /*prize-modify-get the bottomMargin and radio-xiaoping-20190214-end*/
    /**
    ...
    public PreviewFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mShutterGroupHeight = (int)context.getResources().getDimension(R.dimen.shutter_group_height);//prize-add-huangpengfei-2018-12-24
    }
...
//        adapter43display(1440,960);
    ...
    public void setPreviewSize(int width, int height) {
        ...
        mRadio = (double) height / width;
        int dy = (mScreenPixHeight/2+height/2) - (mScreenPixHeight - mShutterGroupHeight);
        if (Math.abs(mRadio - 1.3333) < 0.3
                ||(Math.abs((mRadio - 0.2222))) < 0.3) {
            // video size 176/144=1.2222...
            adapterDisplay(dy);
        } else {
            centerDisplay();
        }
        /*prize-modify-huangpengfei-2019-3-1-end*/
        /*prize-modify-bugid:67064 adjust the position of the focus area-xiaoping-20181102-end*/
        requestLayout();
    }
    ...
    public void setScreenPixHeight(int screenPixHeight) {
        mScreenPixHeight = screenPixHeight;
        /*prize-add for liuhai-huangpengfei-20190302-start*/
        Resources resources = getContext().getResources();
        if (resources.getBoolean(com.android.internal.R.bool.config_fillMainBuiltInDisplayCutout)) {
            int resourceId = resources.getIdentifier("status_bar_height", "dimen", "android");
            int statusBarHeight = resources.getDimensionPixelSize(resourceId);
            mScreenPixHeight -= statusBarHeight;
        }
        /*prize-add for liuhai-huangpengfei-20190302-end*/
    }
    /*prize-modify-bugid:67064 adjust the position of the focus area-xiaoping-20181102-end*/

    /*prize-modify-get the bottomMargin and radio-xiaoping-20190214-start*/
    public int getBottomMarginfor43() {
        return mPreviewBottomMargin;
    }

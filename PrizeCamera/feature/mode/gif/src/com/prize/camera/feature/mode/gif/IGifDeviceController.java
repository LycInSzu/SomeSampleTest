...
public interface IGifDeviceController {
     ...
     */
    void setDeviceCallback(IGifDeviceController.DeviceCallback callback);
     ...
     */
    void takePicture(@Nonnull IGifDeviceController.JpegCallback callback);
     ...
     */
    void setPreviewSizeReadyCallback(IGifDeviceController.PreviewSizeCallback callback);

...
public class FilterRestriction {
    ...
    private static final String FILTER_MODE_KEY =
            "com.prize.camera.feature.mode.filter.FilterMode";
    ...
    static {
        sRelationGroup.setHeaderKey(FILTER_MODE_KEY);
        ...
        sRelationGroup.addRelation(
                new Relation.Builder(FILTER_MODE_KEY, "on")

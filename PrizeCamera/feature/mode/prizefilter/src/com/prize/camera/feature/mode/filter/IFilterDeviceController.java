...
public interface IFilterDeviceController {
     ...
     */
    void setDeviceCallback(com.prize.camera.feature.mode.filter.IFilterDeviceController.DeviceCallback callback);
     ...
     */
    void takePicture(@Nonnull com.prize.camera.feature.mode.filter.IFilterDeviceController.JpegCallback callback);
     ...
     */
    void setPreviewSizeReadyCallback(com.prize.camera.feature.mode.filter.IFilterDeviceController.PreviewSizeCallback callback);
    ...
    interface FilterChangeCallback{
        void onFilterChanged(int index);
    }

    interface FilterParameterCreateCallback{

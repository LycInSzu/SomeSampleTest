...
public class UVFilterEntrance {
    ...
    public SurfaceTexture init(TextureView textureView) {
        ...
        if (null != mUVFilterAdapter) {
            ...
            surfaceTexture = mUVFilterAdapter.init(textureView, true);
    ...
    public void init(int cameraId) {
        if (null != mUVFilterUI) {
            mUVFilterAdapter.init(mSurfaceViews, mUVFilterUI.getWidth(), mUVFilterUI.getHeight(), cameraId, new int[9]);
        } else {

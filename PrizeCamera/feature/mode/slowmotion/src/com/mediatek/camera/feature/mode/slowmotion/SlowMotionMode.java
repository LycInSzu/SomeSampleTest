...
public class SlowMotionMode extends VideoMode {
    ...
    public void init(@Nonnull IApp app, @Nonnull ICameraContext cameraContext,
        ...
        mCanNotContinusShotHint.mBackground = app.getActivity().getDrawable(id);
        mCanNotContinusShotHint.mType = IAppUi.HintType.TYPE_AUTO_HIDE;
        mCanNotContinusShotHint.mHintText = app.getActivity().getString(
    ...
    public boolean onShutterButtonLongPressed() {
        ...
        mApp.getAppUi().showScreenHint(mCanNotContinusShotHint,(int) mApp.getActivity().getResources().getDimension(R.dimen.default_hint_margintop));

...
public interface ISmartScanDeviceController {
     ...
     */
    void setDeviceCallback(ISmartScanDeviceController.DeviceCallback callback);
     ...
     */
    void takePicture(@Nonnull ISmartScanDeviceController.JpegCallback callback);
     ...
     */
    void setPreviewSizeReadyCallback(ISmartScanDeviceController.PreviewSizeCallback callback);

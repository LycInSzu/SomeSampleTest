...
public class SmartScanModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(SmartScanModeHelper.class
            .getSimpleName());
     ...
     */
    public SmartScanModeHelper(ICameraContext cameraContext) {

...
public class SdofPhotoEntry extends FeatureEntryBase {
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mModeTitle = IAppUi.ModeTitle.APERTURE;
        /*prize-modify-huangpengfei-20190307-end*/
        if (CameraApiHelper.getLogicalCameraId() == null) {
            modeItem.mSupportedCameraIds = new String[]{"0", "1"};// zhangguo modify, for bug#74396 dualcam switch icon
        } else {
            modeItem.mSupportedCameraIds = new String[]{"0", "1", CameraApiHelper.getLogicalCameraId()};// zhangguo modify, for bug#74396 dualcam switch icon
        }
        return modeItem;
    }
}
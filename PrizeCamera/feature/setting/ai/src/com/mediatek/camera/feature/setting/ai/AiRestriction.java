...
class AiRestriction {
    ...
    static {
        sRelationGroup.setHeaderKey("key_ai");
        sRelationGroup.setBodyKeys("key_hdr");
        sRelationGroup.addRelation(
                new Relation.Builder("key_ai", "on")
                        .addBody("key_hdr", "off", "off,on,auto")
                        .build());
/*        sRelationGroup.addRelation(
                new Relation.Builder("key_ai", "off")
                        .addBody("key_hdr", "off", "off,on,auto")
                        .build());*/
    }

    /**
     * AI restriction witch are have setting ui.
     * @return restriction list.
     */
     static RelationGroup getAiRestriction() {

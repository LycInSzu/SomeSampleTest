...
public class BeautyParameterViewController {
    ...
    private SeekBar.OnSeekBarChangeListener seekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            /*prize-modify-bugid:74278 drag the progress bar continuously, the entire UI interface is abnormally stuck-xiaoping-20190411-start*/
/*            if (currentKey.equals(BeautyParameter.COMPOSITE_KEY)) {
            ...
            /*prize-modify-bugid:74278 drag the progress bar continuously, the entire UI interface is abnormally stuck-xiaoping-20190411-end*/
        }

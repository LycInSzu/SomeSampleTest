...
public class ContinuousShotRestriction {
    ...
    static {
        ...
        sRelation.setBodyKeys(KEY_DNG + "," + KEY_FACE_DETECTION
                + "," + KEY_DUAL_ZOOM + "," + KEY_ZSD + "," + KEY_FLASH);
        sRelation.addRelation(
                new Relation.Builder(KEY_CSHOT, "on")
                        ...
                        .addBody(KEY_FLASH, "off", "off,on,auto") //modify for bugid:68728
                        .build());
    }
    ...
    static {
        ...
        sFocusUiRelation.addRelation(
                new Relation.Builder(KEY_CSHOT, "on")
                        ...
                        .addBody(KEY_FOCUS, "auto", "auto") // zhangguo add for bug#72229, for continus shot
                        .build());
        sFocusUiRelation.addRelation(
                new Relation.Builder(KEY_CSHOT, "off")
                        .addBody(KEY_FOCUS, FOCUS_UI, "true")
                        .addBody(KEY_FOCUS, null, null) // zhangguo add for bug#72229, for continus shot
                        .build());
    }

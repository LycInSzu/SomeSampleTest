...
public class ContinuousShotNumEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ContinuousShotNumEntry.class.getSimpleName());
    /**
     * create an entry.
     *
     ...
     */
    public ContinuousShotNumEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return ContinuousShotNumEntry.class.getName();
    }

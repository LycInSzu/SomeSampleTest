...
public class IContinuousShotNumViewListener {

    public static final String KEY_CONTINUOUS_SHOT_NUM = "key_continuous_shot_num";
    public static final String ONE_SHOTS = "1";
    public static final String FIVE_SHOTS = "5";
    public static final String TWENTY_SHOTS = "20";
    public static final String FORTY_SHOTS = "40";
    public static final String NINETY_SHOTS = "99";
    /**

...
public class EISCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure {
    ...
    private void configEisSessionRequestParameter(CaptureRequest.Builder captureBuilder,
        ...
        /*prize-modify-Eis switch is off and hidden by default-xiaoping-20190411-start*/
        if ("on".equals(value)) {
            if (FeatureSwitcher.getCurrentProjectValue() == 3) {
        ...
        /*prize-modify-Eis switch is off and hidden by default-xiaoping-20190411-end*/
    }

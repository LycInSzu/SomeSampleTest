...
public class Exposure extends SettingBase implements ExposureView.ExposureViewChangedListener,
    ...
    /*prize-modify flash for model merging-huangpengfei-2019-03-25-start*/
    protected String getCurrentFlashValue() {
        String flashValue = "off";
        if (isSupportFlash()){
            flashValue = mSettingController.queryValue(FLASH_KEY);
        }
    ...
    /*prize-modify flash for model merging-huangpengfei-2019-03-25-end*/

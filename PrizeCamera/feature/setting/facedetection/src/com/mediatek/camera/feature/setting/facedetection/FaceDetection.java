...
public class FaceDetection extends SettingBase {
    ...
    private IFaceConfig.OnDetectedFaceUpdateListener mOnDetectedFaceUpdateListener
        ...
        public void onDetectedFaceUpdate(Face[] faces) {
            ...
            // prize add by zhangguo, for facedetection in video mode begin
            if(mAppUi.getModeItem() != null && (mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.VIDEO || mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.SLOWMOTION)){
                return;
            }
            // prize add by zhangguo, for facedetection in video mode end

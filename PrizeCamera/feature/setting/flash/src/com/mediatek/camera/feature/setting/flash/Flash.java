...
import com.mediatek.camera.common.mode.professional.ProfessionalMode;
...
public class Flash extends SettingBase implements PrizeDataRevert {
    ...
    private static final String FLASH_DEFAULT_VALUE = "auto";//prize-modify for bug[70757]-huangpengfei-2019-01-16
    ...
    public void init(IApp app,
        ...
        if (mAppUi.getModeItem() != null && (mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.PICTUREZOOM || mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.PROFESSIONAL
                || mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.FICSEFILE || mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.LOWLIGHT)) {
    ...
    public void addViewEntry() {
        /*prize-modify-huangpengfei-2019-02-25-start*/
        /*prize-modify-set function of hdr and Set the flash and hdr display-xiaoping-20181018-start*/
        /*if (mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.LOWLIGHT && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PICTUREZOOM
                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.FICSEFILE && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PROFESSIONAL
                && "0".equals(mSettingController.getCameraId())) {
        ...
        /*prize-modify-huangpengfei-2019-02-25-end*/
    }
    ...
    public void refreshViewEntry() {
        ...
        if (num > 1 && isSupportFlash()) {
            ...
            if (FeatureSwitcher.getCurrentProjectValue() != 2 && mApp.isBatteryLow()) {
                onFlashValueChanged(FLASH_OFF_VALUE);
                return;
            }
    ...
    public void onModeOpened(String modeKey, ICameraMode.ModeType modeType) {
        ...
        mModeType = modeType;
        /*prize-modify-set function of hdr and Set the flash and hdr display-xiaoping-20181018-start*/
        if (PictureZoomMode.class.getName().equals(modeKey) || LowLightMode.class.getName().equals(modeKey)
                || PicselfieMode.class.getName().equals(modeKey) || ProfessionalMode.class.getName().equals(modeKey)) {
            /*prize-remove for model merging-huangpengfei-2019-03-25-start*/
            //mLastFlashValue = mDataStore.getValue(getKey(),FLASH_DEFAULT_VALUE,getStoreScope());
            //onFlashValueChanged(FLASH_OFF_VALUE);//prize-modify bug[70975]-huangpengfei-2019-01-24
            /*prize-remove for model merging-huangpengfei-2019-03-25-end*/
            mFlashViewController.showQuickSwitchIcon(false);
        }
        /*prize-modify-set function of hdr and Set the flash and hdr display-xiaoping-20181018-end*/
    }
    ...
    public void onModeClosed(String modeKey) {
        ...
        /*if (PictureZoomMode.class.getName().equals(modeKey) || LowLightMode.class.getName().equals(modeKey)
                || PicselfieMode.class.getName().equals(modeKey) || ProfessionalMode.class.getName().equals(modeKey)) {
            onFlashValueChanged(mLastFlashValue);
        }*/
        /*prize-modify-set function of hdr and Set the flash and hdr display-xiaoping-20181018-end*/
        /*prize-remove for model merging-huangpengfei-2019-03-25-start*/
            ...
            mActivity.runOnUiThread(new Runnable() {
                public void run() {
                    if (supportValues != null) {
                        ...
                        //prize-modify-bugid:69935 do not open the flash on arc algorithm mode 
                    } else if (isFlashSupportedInCurrentMode() && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.FICSEFILE && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PICTUREZOOM
                                                                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.LOWLIGHT && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PROFESSIONAL
                                                                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.HDR && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.GIF
                                                                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PANO) {
                        mFlashViewController.showQuickSwitchIcon(true);
                    }
                }
            });
    ...
    public void onFlashValueChanged(String value) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                if (value == null) return;//prize-add for external intent-huangpengfei-2019-2-16
...
/*                        ((FlashRequestConfigure) mFlashRequestConfigure)
                        ...
                        mDataStore.setValue(KEY_CSHOT,"off",getStoreScope(),true);
    ...
    /*prize-add for front flash-huangpengfei-2019-02-25-start*/
    private boolean isSupportFlash() {
        if (mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.LOWLIGHT && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PICTUREZOOM
                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.FICSEFILE && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PROFESSIONAL
                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.HDR && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.GIF
                && mAppUi.getModeItem().mModeTitle != IAppUi.ModeTitle.PANO) {
            return "0".equals(mSettingController.getCameraId());
        }
        return false;
    }
    /*prize-add for front flash-huangpengfei-2019-02-25-end*/

    /*prize-add -huangpengfei-2019-04-17-start*/
    @Override

...
public class FlashRequestConfigure implements ICameraSetting.ICaptureRequestConfigure {
    ...
    protected void changeFlashToTorchByAeState(boolean needChange) {
        ...
        if (!needChange) {
            ...
            /*prize-modify-bugid:68177-The flash is not turned off after continuous shooting-xiaoping-20181117-start*/
            this.sendSettingChangeRequest();
            /*prize-modify-bugid:68177-The flash is not turned off after continuous shooting-xiaoping-20181117-end*/
            return;
        }

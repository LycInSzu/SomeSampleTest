...
/*prize-modify-hide ExpandView on professional mode-xiaoping-20190322-start*/
import com.mediatek.camera.common.IAppUi;
import com.mediatek.camera.common.app.IApp;
/*prize-modify-hide ExpandView on professional mode-xiaoping-20190322-end*/
...
public class FocusView extends RotateLayout implements IFocusView {
    ...
    /*prize-modify-hide ExpandView on professional mode-xiaoping-20190322-start*/
    private IApp mApp;
    /*prize-modify-hide ExpandView on professional mode-xiaoping-20190322-ebd*/
    ...
    private boolean isExpandViewOutOfDisplayOnBlur() {
        ...
        if (mApp != null && mApp.getAppUi() != null && mApp.getAppUi().getModeItem().mModeTitle == IAppUi.ModeTitle.FICSEFILE) {
            ...
            if(null != integerArrayList && integerArrayList.size() == 2){
    ...
    public void startActiveFocus() {
       ...
       removeCallbacks(mActiveFocusEndAction);
        ...
        mFocusRing.setRotation(0);
        /*prize-modify-hide ExpandView on professional mode-xiaoping-20190322-start*/
        if (!(mApp != null && mApp.getAppUi().getModeItem().mModeTitle == IAppUi.ModeTitle.PROFESSIONAL)) {

...
public class HdrRequestConfigure implements ICameraSetting.ICaptureRequestConfigure, IHdr.Listener {
    ...
    public void setCameraCharacteristics(CameraCharacteristics characteristics) {
        ...
        */
        ...
        /*prize-modify-huangpengfei-2018-11-19-start*/
        //mHdrSessionValue = mHdr.getValue();
        mHdrSessionValue = mHdr.getLocalValue();
        /*prize-modify-huangpengfei-2018-11-19-end*/
    ...
    public void configCaptureRequest(CaptureRequest.Builder captureBuilder) {
        ...
        /*prize-add-set arc hdr parameter-xiaoping-20180911-start*/
        if (HDR_ON_VALUE.equals(mHdr.getValue())) {
            captureBuilder.set(CaptureRequest.VENDOR_ARCSOFT_HDR_MODE, 1);
        } else if (HDR_OFF_VALUE.equals(mHdr.getValue())) {
            captureBuilder.set(CaptureRequest.VENDOR_ARCSOFT_HDR_MODE, 0);
        }
        /*prize-add-set arc hdr parameter-xiaoping-20180911-end*/

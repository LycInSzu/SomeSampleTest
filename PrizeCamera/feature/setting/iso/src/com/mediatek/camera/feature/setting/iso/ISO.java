 ...
 *
 */
public class ISO extends SettingBase implements ISOSettingView.OnValueChangeListener,PrizeDataRevert {
    ...
    public void addViewEntry() {
        LogHelper.i(TAG, "[addViewEntry], mIsSupported:" + mIsSupported);
        if (!mIsSupported) {
            return;
        }
    ...
    /*prize-modify=bugid:67536 ISO value setting error-xiaoping-20181029-start*/
    public String getISOValueInDataStore() {
        return mDataStore.getValue(getKey(),"0",getStoreScope());
    }
    /*prize-modify=bugid:67536 ISO value setting error-xiaoping-20181029-end*/

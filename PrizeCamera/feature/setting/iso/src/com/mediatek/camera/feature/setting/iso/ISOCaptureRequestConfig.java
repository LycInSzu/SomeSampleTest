...
public class ISOCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure {
    ...
    public void configCaptureRequest(CaptureRequest.Builder captureBuilder) {
        ...
        String value = mIso.getISOValueInDataStore();
        LogHelper.d(TAG, "[configCaptureRequest], value:" + value+",getValueInDataStore: "+mIso.getISOValueInDataStore());
        /*prize-modify=bugid:67536 ISO value setting error-xiaoping-20181029-end*/
        if (value != null && captureBuilder != null && null != mKeyIsoRequestValue) {
            int[] mode = new int[1];

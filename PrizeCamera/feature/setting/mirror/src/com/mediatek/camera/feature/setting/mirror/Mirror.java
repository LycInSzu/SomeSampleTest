...
public class Mirror extends SettingBase implements MirrorSettingView.OnMirrorClickListener {
    ...
    private static final String KEY_MIRROR = "key_mirror";
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new MirrorSettingView(getKey());
            mSettingView.setMirrorOnClickListener(this);
            // [Add for CCT tool] Receive keycode and enable/disable Mirror @{
    ...
    public void refreshViewEntry() {
        if (mSettingView != null) {
            ...
            mAppUi.setMirrorEnable(VALUE_ON.equals(getValue()));
    ...
    public IParametersConfigure getParametersConfigure() {
        ...
        if (mSettingChangeRequester == null) {
            MirrorParametersConfig config = new MirrorParametersConfig(this, mSettingDeviceRequester);
            mSettingChangeRequester = config;
        }
        return (MirrorParametersConfig) mSettingChangeRequester;
    }
    ...
    public ICaptureRequestConfigure getCaptureRequestConfigure() {
        ...
        if (mSettingChangeRequester == null) {
            MirrorCaptureRequestConfig config = new MirrorCaptureRequestConfig(
    ...
    @Override
    public void onMirrorClicked(boolean checked) {
        ...
        /*prize-add mirror-huangpengfei-2019-03-02-start*/
        mAppUi.setMirrorEnable(VALUE_ON.equals(value));
        /*prize-add mirror-huangpengfei-2019-03-02-end*/
    ...
    /*prize-modify-bug The mirror switch appears when the camera is cut to the third camera-xiaoping-20190425-start*/
    public String getCameraId() {
        return mSettingController.getCameraId();
    }
    /*prize-modify-bug The mirror switch appears when the camera is cut to the third camera-xiaoping-20190425-end*/
}

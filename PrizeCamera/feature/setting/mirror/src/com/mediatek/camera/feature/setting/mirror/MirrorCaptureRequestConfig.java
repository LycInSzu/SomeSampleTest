...
public class MirrorCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure {
    ...
    private static final String MIRROR_DEFAULT_VALUE = (("1").equals(android.os.SystemProperties.get("ro.pri.front.mirror", "0")))? "on" : "off";
    ...
    public void setCameraCharacteristics(CameraCharacteristics characteristics) {
        ...
        if (facing != null && "1".equals(mMirror.getCameraId())){
        ...
        mMirror.initializeValue(platformSupportedValues, MIRROR_DEFAULT_VALUE);
    }

 ...
 */
public class MirrorParametersConfig implements ICameraSetting.IParametersConfigure {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(
           MirrorParametersConfig.class.getSimpleName());
     ...
     */
    public MirrorParametersConfig(Mirror mirror,
    ...
    public void setOriginalParameters(Camera.Parameters originalParameters) {
        ...
        mMirror.initializeValue(supportedValues, defaultValue);
    }

    @Override
    public boolean configParameters(Camera.Parameters parameters) {
        if (mMirror.getValue() == null) {
            return false;
        }
        boolean changed = !(mMirror.getValue().equals(mValue));
        parameters.set(KEY_MIRROR_MODE, mMirror.getValue());
        mValue = mMirror.getValue();
        return changed;
    }
    ...
    public void sendSettingChangeRequest() {
        mDeviceRequester.requestChangeSettingValue(mMirror.getKey());
    }

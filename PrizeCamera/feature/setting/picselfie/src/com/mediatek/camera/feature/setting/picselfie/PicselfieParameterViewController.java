...
public class PicselfieParameterViewController {
    ...
    public static final int PICSELFIE_PRIORITY = 4;
    ...
    public PicselfieParameterViewController(PicselfieParameter picselfieParameter, IApp app) {
        ...
        mHintInfo.mHintText = app.getActivity().getString(R.string.camera_slr_mode_tips);
    }
    ...
    private ImageView iniIndicatorView() {
        ...
        if (VALUES_ON.equals(mPicselfieParameter.getPicsefileSwitchValue())) {
        ...
        mPicselfieIndicatorView.setTag(mPicselfieValue);
        ...
        mPicselfieIndicatorView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(VALUES_ON.equals(mPicselfieValue)){
                    ...
                    mPicselfieValue = VALUES_ON;
                    mPicselfieIndicatorView.setImageResource(R.drawable.picselfie_on);
                    /*prize-modify-add tips of picselfiemode -xiaoping-20190417-start*/
                    showHintInfoTips();
    ...
    public void onAiTurnsOn(){
        if(null != mPicselfieIndicatorView && "on".equals(mPicselfieValue)){
            mPicselfieIndicatorView.post(new Runnable() {
                @Override
                public void run() {
                    mPicselfieIndicatorView.performClick();
                }
            });
        }
    }
    ...
    /*prize-modify-add tips of picselfiemode -xiaoping-20190417-start*/
    private void showHintInfoTips(){
        if (mApp.getAppUi() != null && mApp.getAppUi().getModeItem().mModeTitle == IAppUi.ModeTitle.PHOTO) {
            mApp.getAppUi().showScreenHint(mHintInfo,(int) mApp.getActivity().getResources().getDimension(R.dimen.hdr_tips_margin_top));
        }
    }
    /*prize-modify-add tips of picselfiemode -xiaoping-20190417-end*/

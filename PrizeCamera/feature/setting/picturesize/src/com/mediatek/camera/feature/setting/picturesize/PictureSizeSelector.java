...
public class PictureSizeSelector extends PrizePreferenceFragment {//prize-tangan-add prize camera-begin
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(PictureSizeSelector.class.getSimpleName());
    private static final double DEGRESSIVE_RATIO = 0.5;
    private static final int MAX_COUNT = 1;//3 prize-only show one size-tangan-20181019
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.pref_camera_picturesize_title);
		//prize-tangan-add prize camera-end

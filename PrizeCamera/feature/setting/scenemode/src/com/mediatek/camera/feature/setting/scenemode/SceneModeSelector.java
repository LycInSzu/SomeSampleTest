...
public class SceneModeSelector extends PrizePreferenceFragment {//prize-tangan-add prize camera-begin
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.pref_camera_scenemode_title);
		//prize-tangan-add prize camera-end
    ...
    private class MyOnPreferenceClickListener implements Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            LogHelper.d(TAG,"[onPreferenceClick]  value = " + value);

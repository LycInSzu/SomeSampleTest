...
import android.content.Intent;   /* intent for gts  begin */
...
public class SelfTimer extends SettingBase implements IAppUiListener.OnShutterButtonListener,PrizeDataRevert {
    ...
    public boolean onShutterButtonClick() {
        ...
        if (mIsTimerStarted) {
            ...
            if (FeatureSwitcher.getCurrentProjectValue() == 2 && mSelfTimerCtrl != null) {
                mSelfTimerCtrl.onInterrupt();
    ...
    private ISelfTimerViewListener.OnSelfTimerListener mSelfTimerListener
        ...
        public void onTimerDone() {
            ...
            mAppUi.setSelfTimerState(false);
            ...
            /*prize-modify-bugid:70202 hide beauty progress bar during timed photo taking-xiaoping-20181228-start*/
            if (mAppUi.getModeItem().mModeTitle == IAppUi.ModeTitle.BEAUTY) {
                mAppUi.getSettingRoot().setVisibility(View.VISIBLE);
            }
            /*prize-modify-bugid:70202 hide beauty progress bar during timed photo taking-xiaoping-20181228-end*/
            mAppUi.triggerShutterButtonClick(HIGHEST_PRIORITY);
        }
        ...
        public void onTimerStart() {
            ...
            mAppUi.setSelfTimerState(true);
            /*prize-modify-feature:k6203vs-can take a photo before the countdown ends-xiaoping-20190417-start*/
            if (FeatureSwitcher.getCurrentProjectValue() != 2) {
                mAppUi.setUIEnabled(IAppUi.SHUTTER_BUTTON,false);
            }
            /*prize-modify-feature:k6203vs-can take a photo before the countdown ends-xiaoping-20190417-end*/
            ...
            mAppUi.setUIVisibility(IAppUi.CAMERA_SWITCHER,View.INVISIBLE);
            /*prize-modify-bug the bottom camera shutter button is hidden in the countdown state-xiaoping-20190325-end*/
            /*prize-modify-bugid:70202 hide beauty progress bar during timed photo taking-xiaoping-20181228-start*/
            mAppUi.getSettingRoot().setVisibility(View.INVISIBLE);
            /*prize-modify-bugid:70202 hide beauty progress bar during timed photo taking-xiaoping-20181228-end*/
        }
    };
    ...
    private void initSettingValue() {
        ...
        parseIntent();   /* intent for gts  begin */
   ...
   /* intent for gts  begin */   
    ...
    /*prize-add-huangpengfei-2018-11-17-start*/
    @Override

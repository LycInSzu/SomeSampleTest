...
public class VideoMuteCaptureRequestConfig implements ICameraSetting.ICaptureRequestConfigure {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(
            VideoMuteCaptureRequestConfig.class.getSimpleName());
    private static final String VALUE_ON = "on";
    private static final String VALUE_OFF = "off";

    public VideoMuteCaptureRequestConfig(VideoMute cameraMute, ISettingManager.SettingDevice2Requester settingDevice2Requester) {
        mCameraMute = cameraMute;
        mSettingDevice2Requester = settingDevice2Requester;
    }

    private final VideoMute mCameraMute;

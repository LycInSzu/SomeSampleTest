...
public class Watermark extends SettingBase implements WatermarkSettingView.OnWatermarkClickListener {
    ...
    // [Add for CCT tool] Receive keycode and enable/disable Watermark @{
    ...
    public void addViewEntry() {
        ...
        if (mSettingView == null) {
            mSettingView = new WatermarkSettingView(getKey());
            mSettingView.setWatermarkOnClickListener(this);
            // [Add for CCT tool] Receive keycode and enable/disable Watermark @{
    ...
    public IParametersConfigure getParametersConfigure() {
        ...
        if (mSettingChangeRequester == null) {
            WatermarkParametersConfig config = new WatermarkParametersConfig(this, mSettingDeviceRequester);
            mSettingChangeRequester = config;
        }
        return (WatermarkParametersConfig) mSettingChangeRequester;
    }
    ...
    public ICaptureRequestConfigure getCaptureRequestConfigure() {
        ...
        if (mSettingChangeRequester == null) {
            WatermarkCaptureRequestConfig config = new WatermarkCaptureRequestConfig(
    ...
    @Override
    public void onWatermarkClicked(boolean checked) {
        String value = checked ? VALUE_ON : VALUE_OFF;
        LogHelper.d(TAG, "[onWatermarkClicked], value:" + value);
        setValue(value);
    ...
    /**
     * Initialize Watermark values when platform supported values is ready.
     *

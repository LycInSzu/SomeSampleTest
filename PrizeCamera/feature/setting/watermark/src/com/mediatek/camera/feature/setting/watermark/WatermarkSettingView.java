...
public class WatermarkSettingView implements ICameraSettingView {
    ...
    /**
     * Listener to listen Watermark is clicked.
     */
    public interface OnWatermarkClickListener {
        /**
         * Callback when Watermark item is clicked by user.
         *
         * @param checked True means Watermark is opened, false means Watermark is closed.
         */
        void onWatermarkClicked(boolean checked);
    }

    /**
     * Watermark setting view constructor.
     *
     * @param key The key of setting.
     */
    public WatermarkSettingView(String key) {
        mKey = key;
    }

    @Override
    public void loadView(PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.watermark_preference);
    ...
    /**
     * Set listener to listen Watermark is clicked.
     *
     * @param listener The instance of {@link OnWatermarkClickListener}.
     */
    public void setWatermarkOnClickListener(OnWatermarkClickListener listener) {
        mListener = listener;
    }
        ...
        return new IApp.KeyEventListener() {
            ...
            public boolean onKeyUp(int keyCode, KeyEvent event) {
                ...
                if (keyCode == CameraUtil.KEYCODE_ENABLE_ZSD && mPref.isEnabled()) {
                    mChecked = true;
                    mListener.onWatermarkClicked(true);
                } else if (keyCode == CameraUtil.KEYCODE_DISABLE_ZSD && mPref.isEnabled()) {
                    mChecked = false;
                    mListener.onWatermarkClicked(false);
                }
                return true;
            }
        };

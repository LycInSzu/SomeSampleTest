...
public class WhiteBalance extends SettingBase implements
        WhiteBalanceSettingView.OnValueChangeListener,PrizeDataRevert {
    ...
    public void refreshViewEntry() {
        LogHelper.d(TAG,"[refreshViewEntry]  getEntryValues().size() = " + getEntryValues().size() +
                    "   getValue() = " + getValue() + "   mIndicatorView = "+mIndicatorView );
        mActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                    if (mSettingView != null) {
    ...
    public synchronized String getValue() {
        return /*super.getValue()*/mDataStore.getValue(getKey(),"auto",getStoreScope());
    }

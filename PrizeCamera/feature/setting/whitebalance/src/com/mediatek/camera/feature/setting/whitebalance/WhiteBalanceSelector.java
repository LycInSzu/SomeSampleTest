...
public class WhiteBalanceSelector extends PrizePreferenceFragment {//prize-tangan-add prize camera-begin
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.pref_camera_whitebalance_title);
		//prize-tangan-add prize camera-end

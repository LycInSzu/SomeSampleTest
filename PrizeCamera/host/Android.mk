...
LOCAL_STATIC_JAVA_LIBRARIES += uvsl_uvfilter
LOCAL_STATIC_JAVA_LIBRARIES += uvsl_uvpano
LOCAL_STATIC_JAVA_LIBRARIES += zxing-3.3.3
...
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/continuousshotnum/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/touchshutter/res
...
#prize-add-huangpengfei-20180910-start
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/professional/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/grid/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/volumekeys/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/ai/res
#prize-add-huangpengfei-20180910-end

#prize-add-cameramute setting-xiaoping-20181009-start
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/cameramute/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/picselfie/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/storagepath/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/location/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/videomute/res
#prize-add-cameramute setting-xiaoping-20181009-end
#prize-add-screen flash-huangzhanbin-20190226-start
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/setting/screenflash/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/mode/gif/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/mode/prizefilter/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/mode/prizepano/res
LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/../feature/mode/smartscan/res
...
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/touchshutter/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/continuousshotnum/src)
#prize-tangan-20180921-add prize camera-end
...
#prize-add-add mode and setting -xiaoping-20180901-start
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/beautyparameter/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/picturezoom/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/lowlight/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/picselfie/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/cameramute/src)
...
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/videomute/src)
#prize-add-add mode and setting-xiaoping-20180901-end

#prize-add-huangpengfei-20180910-start
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/professional/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/grid/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/volumekeys/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/ai/src)
#prize-add-huangpengfei-20180910-end

#prize-add-screen flash-huangzhanbin-20190226-start
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/setting/screenflash/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/mode/gif/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/mode/prizefilter/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/mode/prizepano/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../feature/mode/smartscan/src)
#prize-add-screen flash-huangzhanbin-20190226-end
...
LOCAL_JNI_SHARED_LIBRARIES += libjni_uvfilter
LOCAL_JNI_SHARED_LIBRARIES += libjni_uvpanorama
...
include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := uvsl_uvfilter:libs/uvsl_uvfilter.jar
include $(BUILD_MULTI_PREBUILT)

include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := uvsl_uvpano:libs/uvsl_uvpano.jar
include $(BUILD_MULTI_PREBUILT)

include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := zxing-3.3.3:libs/zxing-3.3.3.jar
include $(BUILD_MULTI_PREBUILT)

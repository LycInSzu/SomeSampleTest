...
public class PrizeSeekBar extends View {
    ...
    private int mDefaultProgress;// zhangguo add for bug#74475 reset settings
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mDefaultProgress = mSelectProgress;// zhangguo add for bug#74475 reset settings
        initView();
        attr.recycle();
    ...
    public void reset(){
        mSelectProgress = mDefaultProgress;
        mCurrentLevel = 4;
    }

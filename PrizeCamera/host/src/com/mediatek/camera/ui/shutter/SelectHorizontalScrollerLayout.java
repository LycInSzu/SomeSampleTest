...
public class SelectHorizontalScrollerLayout extends HorizontalScrollView {
	...
	private int mRtlOffset;//prize-add fixbug[74132]-huangpengfei-20190409
...
//        setBackgroundColor(Color.TRANSPARENT);
     // Disable the Scroll Bar
		...
		mRtlOffset = (int) context.getResources().getDimension(R.dimen.shutter_type_title_rtl_offset);//prize-add fixbug[74132]-huangpengfei-20190409
    }
...
//				- Utils.getMarginStart(selectedTab);
		...
		x -= (first - selected) / 2;
		/*prize-add fixbug[74132]-huangpengfei-20190409-start*/
		if (isLayoutRtl()) {
			x -= mRtlOffset;
		}
		/*prize-add fixbug[74132]-huangpengfei-20190409-end*/
        	...
        	case MotionEvent.ACTION_MOVE:
        		if (!mIsChange && mScrollStrip.getChildAt(mSelectIndex) != null) {
            		...
            		if ((mSelectIndex < mScrollStrip.getChildCount() - 1) && (mDownX - currentX > (width / 2))) {
            			mIsChange = true;
						/*prize-modify Rtl fixbug[74133]-huangpengfei-20190409-start*/
						if (isLayoutRtl()) {
						...
						/*prize-modify Rtl fixbug[74133]-huangpengfei-20190409-end*/
            		}

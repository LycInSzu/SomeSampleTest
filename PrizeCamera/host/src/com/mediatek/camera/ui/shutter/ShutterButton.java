...
class ShutterButton extends RotateImageView implements View.OnLongClickListener {
    ...
    public ShutterButton(Context context, AttributeSet attrs) {
        ...
        PropertyValuesHolder scaleX =  PropertyValuesHolder.ofFloat("scaleX", 1.0f, 1.0f);//prize-tangan-20180929-ui option
        PropertyValuesHolder scaleY =  PropertyValuesHolder.ofFloat("scaleY", 1.0f, 1.0f);//prize-tangan-20180929-ui option
    ...
    public boolean performClick() {
        ...
        android.util.Log.d("ShutterButton",
                "performClick isEnabled()="+isEnabled()+",isClickable()="+isClickable()+",mLongPressed="+mLongPressed);//prize-added by tangan-20190327-add log

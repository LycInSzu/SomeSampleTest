...
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES += vendor.goodix.hardware.biometrics.fingerprint-V2.1-java:vendor.goodix.hardware.biometrics.fingerprint-V2.1-java.jar

package com.pri.factorytest.GPS;
...
public class GPS extends PrizeBaseActivity {
    ...
    private void openGPSSettings() {
        Settings.Secure
                .putIntForUser(getContentResolver(), Settings.Secure.LOCATION_MODE, Settings.Secure.LOCATION_MODE_HIGH_ACCURACY, UserHandle.myUserId());
    ...
    void stopGPS() {
        try {
            Settings.Secure
                .putIntForUser(getContentResolver(), Settings.Secure.LOCATION_MODE, Settings.Secure.LOCATION_MODE_OFF, UserHandle.myUserId());
    ...
    BaseAdapter mAdapter = new BaseAdapter() {
        ...
        public int getCount() {
            return Optional.ofNullable(satelliteList).map(x -> x.size()).orElse(0);
        }

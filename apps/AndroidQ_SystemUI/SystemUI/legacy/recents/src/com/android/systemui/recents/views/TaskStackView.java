...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
   ...
   public void updateLayoutAlgorithm(boolean boundScrollToNewMinMax,
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //add for XWYYQ-191 by liyuchong 20191218 begin
        ...
        //add for XWYYQ-191 by liyuchong 20191218 end
    }
    ...
    public void onStackScrollChanged(float prevScroll, float curScroll, AnimationProps animation) {
        ...
        if (mEnterAnimationComplete && !useGridLayout()) {
            ...
            if (prevScroll > SHOW_STACK_ACTION_BUTTON_SCROLL_THRESHOLD &&
                ...
                //delete for XWYYQ-191 by liyuchong 20191218 begin
//                EventBus.getDefault().send(new HideStackActionButtonEvent());
                //delete for XWYYQ-191 by liyuchong 20191218 end
            }
        }
    }

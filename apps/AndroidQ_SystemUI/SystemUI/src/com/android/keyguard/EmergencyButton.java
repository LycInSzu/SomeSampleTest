...
public class EmergencyButton extends Button {
    ...
    //add EWSWQ-436 xudong.zhang 20200316(start)
    private boolean hasTokenEmergencyCallAction = false;
    public Handler mDelayTokenHandler = new Handler(){
        @Override
        public void handleMessage(Message msg) {
            hasTokenEmergencyCallAction = false;
        }
    };
    //add EWSWQ-436 xudong.zhang 20200316(end)
    ...
    public void takeEmergencyCallAction() {
        ...
        //add EWSWQ-436 xudong.zhang 20200316(start)
        if(hasTokenEmergencyCallAction){
            return;
        }else{
            hasTokenEmergencyCallAction = true;
            mDelayTokenHandler.sendEmptyMessageDelayed(77, 1500);
        }
        //add EWSWQ-436 xudong.zhang 20200316(end)
    ...
    private void updateEmergencyCallButton() {
        ...
        if (mLocateAtNonSecureView && !mEmergencyButtonExt.showEccInNonSecureUnlock()) {
            ...
            //modify BugID:XWELY-848 gaoshan 20161222 start
                /*show = (visible || antiTheftLocked
                        || mEmergencyButtonExt.showEccInNonSecureUnlock())
                        && eccShouldShow;*/
            show = visible || ((antiTheftLocked|| mEmergencyButtonExt.showEccInNonSecureUnlock())
                    && eccShouldShow);
            //modify BugID:XWELY-848 gaoshan 20161222 end

...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    public static  boolean IS_FINGERPRINT_LOCKOUT=false;
    ...
    private void handleFingerprintError(int msgId, String errString) {
        //add for EJQQ-1078 by liyuchong 20191101 begin
        if ((msgId == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT || msgId == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT_PERMANENT) && !IS_FINGERPRINT_LOCKOUT){
            IS_FINGERPRINT_LOCKOUT=true;
        }
        //add for EJQQ-1078 by liyuchong 20191101 end

...
public class Dependency extends SystemUI {
    ...
    public static final DependencyKey<ExtremeModeHelper> EXTREME_MODE_HELPER = new DependencyKey<>("extreme_mode_helper");
    ...
    public void start() {
        ...
        mProviders.put(EXTREME_MODE_HELPER, () -> {
            return new ExtremeModeHelper(mContext);
        });

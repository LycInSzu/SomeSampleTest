...
public class ScreenDecorations extends SystemUI implements Tunable,
    ...
    //add by wangjian for TEJBB-225 20200312 start
    private boolean mShouldShowAssistHint = true;
    //add by wangjian for TEJBB-225 20200312 end
    ...
    public void start() {
        ...
        //add by wangjian for TEJBB-225 20200312 start
        mShouldShowAssistHint = mContext.getResources().getBoolean(R.bool.config_show_assist_hint);
        //add by wangjian for TEJBB-225 20200312 end
    }
    ...
    static boolean shouldDrawCutout(Context context) {
        //modify by wangjian for liuhai switch start
        //return context.getResources().getBoolean(
        //        com.android.internal.R.bool.config_fillMainBuiltInDisplayCutout);
        return context.getResources().getBoolean(
                com.android.internal.R.bool.config_fillMainBuiltInDisplayCutout)&& Settings.System.getInt(context.getContentResolver(),
                Settings.System.SWIPE_LIUHAI_STATUS, 0) == 0;
        //modify by wangjian for liuhai switch end
    ...
    public static class DisplayCutoutView extends View implements DisplayManager.DisplayListener,
        ...
        private int mRotation;
        //add by wangjian for liuhai EJWJ-51 20190605 start
        private static int liuhaiOffsetX = 0;
        private static int liuhaiOffsetY = 0;
        private static float liuhaiScaleX = 1.0f;
        private static float liuhaiScaleY = 1.0f;
        //add by wangjian for liuhai EJWJ-51 20190605 end
        ...
        public DisplayCutoutView(Context context, boolean start,
            ...
            //add by wangjian for liuhai switch start
            context.getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.SWIPE_LIUHAI_STATUS), false, mSwapLiuHaiOberver, UserHandle.USER_ALL);
            //add by wangjian for liuhai switch end
            //add by wangjian for liuhai EJWJ-51 20190605 start
            liuhaiOffsetX = context.getResources().getInteger(R.integer.liuhai_offset_x);
            liuhaiOffsetY = context.getResources().getInteger(R.integer.liuhai_offset_y);
            liuhaiScaleX = context.getResources().getFloat(R.dimen.liuhai_scale_x);
            liuhaiScaleY = context.getResources().getFloat(R.dimen.liuhai_scale_y);
            //add by wangjian for liuhai EJWJ-51 20190605 end
        }
        ...
        private static void transformPhysicalToLogicalCoordinates(@Surface.Rotation int rotation,
            ...
            switch (rotation) {
                case ROTATION_0:
                    out.reset();
                    //add by wangjian for liuhai EJWJ-51 20190605 start
                    out.postScale(liuhaiScaleX,liuhaiScaleY);
                    out.postTranslate(liuhaiOffsetX, liuhaiOffsetY);
                    //add by wangjian for liuhai EJWJ-51 20190605 end
                    break;
                case ROTATION_90:
                    out.setRotate(270);
                    //modify by wangjian for liuhai EJWJE-495 20191021 start
                    //out.postTranslate(0, physicalWidth);
                    out.postScale(liuhaiScaleY,liuhaiScaleX);
                    out.postTranslate(liuhaiOffsetY, physicalWidth - liuhaiOffsetX);
                    //modify by wangjian for liuhai EJWJE-495 20191021 end
                    break;
                case ROTATION_180:
                    out.setRotate(180);
                ...
                case ROTATION_270:
                    ...
                    out.postScale(liuhaiScaleY,liuhaiScaleX);
                    //modify by wangjian for liuhai TELLB-249 20200226 start
                    //out.postTranslate(liuhaiOffsetY + physicalHeight, liuhaiOffsetX);
                    out.postTranslate(physicalHeight - liuhaiOffsetY, liuhaiOffsetX);
                    //modify by wangjian for liuhai TELLB-249 20200226 end
                    //modify by wangjian for liuhai EJWJE-495 20191021 end
                    break;
                default:
        ...
        //add by wangjian for liuhai switch start
        private ContentObserver mSwapLiuHaiOberver = new ContentObserver(new Handler()) {
            @Override
            public void onChange(boolean selfChange) {
                super.onChange(selfChange);
                int status  = Settings.System.getInt(mContext.getContentResolver(), Settings.System.SWIPE_LIUHAI_STATUS, 0);
                Log.i(TAG, "mSwapLiuHaiOberver onChange status = " + status);
                update();
            }
        };
        //add by wangjian for liuhai switch end

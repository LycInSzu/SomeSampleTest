...
public class PowerUI extends SystemUI {
    ...
    //add by liutao for EJQQ-1162 20191128 start
    final static String REVERSE_PATH = "/sys/bus/i2c/drivers/mt5725/6-002b/mt5725group/reverse_charger";
    //add by liutao for EJQQ-1162 20191128 end
    ...
    final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (PowerManager.ACTION_POWER_SAVE_MODE_CHANGED.equals(action)) {
                ...
                //add by liutao for EJQQ-1162 20191128 start
                if (context.getResources().getBoolean(com.android.internal.R.bool.have_reverse_wire_less_charge)
                        && Settings.System.getInt(context.getContentResolver(), "reverse_wire_less_charge", 0) == 1) {
                    if (mBatteryLevel <= 20) {
                        Slog.w(TAG, "rockye close reverse_wire_less_charge");
                        Settings.System.putInt(context.getContentResolver(), "reverse_wire_less_charge", 0);
                        mPowerManager.setSysClassValue(REVERSE_PATH, 0);
                    }
                }
                // add by liutao for EJQQ-1162 20191128 end

...
//modify for EJQQQ-80 by liyuchong 20191204 end
    ...
    //add for TEJWQE-424 by liyuchong 20200402 begin
    private View mManageNotifications;
...
// delete for EJQQ-1123 by liyuchong 20191029 end
    ...
    protected void onFinishInflate() {
        ...
        //modify for TEJWQE-424 by liyuchong 20200402 begin
        /*mSettingsButton = findViewById(R.id.settings_button);
        mSettingsContainer = findViewById(R.id.settings_button_container);
        mSettingsButton.setOnClickListener(this);*/
        if(!SystemUIApplication.useBluCustomUI) {
            mSettingsButton = findViewById(R.id.settings_button);
            mSettingsContainer = findViewById(R.id.settings_button_container);
            mSettingsButton.setOnClickListener(this);
        }else {
            ((ViewGroup) mActionsContainer).removeView(mActionsContainer.findViewById(R.id.settings_button_container));
        }
        //modify for TEJWQE-424 by liyuchong 20200402 end
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            ...
            mAlarmStatus = findViewById(R.id.alarm_status);
            mNextAlarmController = Dependency.get(NextAlarmController.class);
            mManageNotifications = findViewById(R.id.notification_manage);
            mManageNotifications.setOnClickListener(this);
        }
        // RenderThread is doing more harm than good when touching the header (to expand quick
        // settings), so disable it for this view
        if(!SystemUIApplication.useBluCustomUI) {
            ((RippleDrawable) mSettingsButton.getBackground()).setForceSoftware(true);
            ((ViewGroup) mActionsContainer).removeView(mActionsContainer.findViewById(R.id.notification_manage));
        }
        //add for TEJWQE-424 by liyuchong 20200402 end
        updateResources();
...
//        modify for EJQQ-1123 by liyuchong 20191029 end
    ...
    private TouchAnimator createFooterAnimator() {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            ...
            final int offset = mContext.getResources().getDimensionPixelSize(R.dimen.qs_footer_dtgroup_offset);
            return new TouchAnimator.Builder()
                    .addFloat(mActionsContainer, "alpha", 0, 1)
                    .addFloat(mEditContainer, "alpha", 0, 1)
                    .addFloat(mDragHandle, "alpha", 1, 0, 0)
...
//        mSettingsButton.setClickable(mSettingsButton.getVisibility() == View.VISIBLE);
        if (!SystemUIApplication.useBluCustomUI) {
            ...
            mManageNotifications.setClickable(mManageNotifications.getVisibility() == View.VISIBLE);
        }
        //modify for TEJWQE-424 by liyuchong 20200402 end
    }
...
//        mSettingsButton.setVisibility(isDemo || !mExpanded ? View.INVISIBLE : View.VISIBLE);
        if (!SystemUIApplication.useBluCustomUI) {
            ...
            mManageNotifications.setVisibility(isDemo || !mExpanded ? View.INVISIBLE : View.VISIBLE);
        }
        //modify for TEJWQE-424 by liyuchong 20200402 end
    }
    ...
    public void onClick(View v) {
        ...
        if (v == mSettingsButton) {
            ...
            //add for TEJWQE-424 by liyuchong 20200402 begin
        }else if (v == mManageNotifications) {
            ...
            if(mStatusBar!=null){
                mStatusBar.manageNotifications();
            }
        }
        //add for TEJWQE-424 by liyuchong 20200402 end
    }
    ...
    public void onUserInfoChanged(String name, Drawable picture, String userAccount) {
        if (picture != null &&
            ...
            picture.setColorFilter(
                    //modify by wangjian for EJQQQ-574 20200225 start
                    //Utils.getColorAttrDefaultColor(mContext, android.R.attr.colorForeground),
                    Utils.getColorAttrDefaultColor(mContext, android.R.attr.colorError),
                    //modify by wangjian for EJQQQ-574 20200225 end
                    Mode.SRC_IN);
        }

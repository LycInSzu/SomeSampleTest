...
//        mFooter = view.findViewById(R.id.qs_footer);
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer));
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer_blu));
            mFooter = view.findViewById(R.id.qs_footer_dg);
        }else if(SystemUIApplication.useBluCustomUI){
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer));
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer_dg));
            mFooter = view.findViewById(R.id.qs_footer_blu);
        }else {
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer_blu));
            ((ViewGroup) view).removeView((View) view.findViewById(R.id.qs_footer_dg));
            mFooter = view.findViewById(R.id.qs_footer);

...
import com.android.systemui.qs.tiles.ScreenRecordingTile;
import com.android.systemui.qs.tiles.ScreenshotTile;
//add AudioProfile by wangjian for XWYYQ-44 20191214 start
import com.android.systemui.qs.tiles.AudioProfileTile;
//add AudioProfile by wangjian for XWYYQ-44 20191214 end
// add for TEWSL-177 by liyuchong 20190926 begin
import com.android.systemui.qs.tiles.ScreenRecorderTile;
// add for TEWSL-177 by liyuchong 20190926 end
//add for EJWJE-412 by liyuchong 20191028 begin
import com.android.systemui.qs.tiles.CalculatorTile;
import com.android.systemui.qs.tiles.CameraTile;
import com.android.systemui.qs.tiles.AlarmTile;
import com.android.systemui.qs.tiles.PowerTile;
import com.android.systemui.qs.tiles.VoiceTile;
//add for EJWJE-412 by liyuchong 20191028 end
...
public class QSFactoryImpl implements QSFactory {
    ...
    private QSTileImpl createTileInternal(String tileSpec) {
        ...
        switch (tileSpec) {
            ...
            //delete by wangjian for TEWBW-337 20191228 start
            /*
            case "cast":
                return mCastTileProvider.get();*/
            //delete by wangjian for TEWBW-337 20191228 end
            // add for TEWSL-177 by liyuchong 20190926 begin
            case "screenrecorder":
                return new ScreenRecorderTile(mHost);
            // add for TEWSL-177 by liyuchong 20190926 end
            case "hotspot":
            ...
            // Add by zhiheng.huang on 2018/11/17 for YJSQ-118 start >>>>>>>>>>
            case "screenrecording":
                return  new ScreenRecordingTile(mHost);
            // Add by zhiheng.huang on 2018/11/17 for YJSQ-118 end <<<<<<<<<<<<<<<
            ...
            //add AudioProfile by wangjian for XWYYQ-44 20191214 start
            case "audioprofiles":
                return new AudioProfileTile(mHost);
            //add AudioProfile by wangjian for XWYYQ-44 20191214 end
            //add for EJWJE-412 by liyuchong 20191028 begin
            case "alarm":
                return new AlarmTile(mHost);
            case "calc":
                return new CalculatorTile(mHost);
            case "camera":
                return new CameraTile(mHost);
            case "power":
                return new PowerTile(mHost);
            case "voice":
                return new VoiceTile(mHost);
            //add for EJWJE-412 by liyuchong 20191028 end
        }

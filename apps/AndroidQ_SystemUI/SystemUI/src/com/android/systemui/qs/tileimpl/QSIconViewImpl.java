...
public class QSIconViewImpl extends QSIconView {
    ...
    protected void setIcon(ImageView iv, QSTile.State state, boolean allowAnimations) {
        ...
        //modify by wangjian for TEJBB-229 20200312 start
        //if (state.state != mState) {
        if (state.state != mState && !SystemUIApplication.useDkCustomUI) {
        //modify by wangjian for TEJBB-229 20200312 end
    ...
    public static void setTint(ImageView iv, int color) {
        //modify for EWSWQ-275 by liyuchong 20200224 begin
        ...
        //modify for EWSWQ-275 by liyuchong 20200224 end
    }

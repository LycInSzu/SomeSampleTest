...
public class QSTileBaseView extends com.android.systemui.plugins.qs.QSTileView {
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
        super(context);
        //add for EJQQQ-80 by liyuchong 20191204 begin
        hideBg= context.getResources().getBoolean(R.bool.config_hide_qstile_background);
        //add for EJQQQ-80 by liyuchong 20191204 end
...
//        mColorInactive = Utils.getColorAttrDefaultColor(context, android.R.attr.textColorSecondary);
        if (SystemUIApplication.useDgCustomUI){
            mColorActive = context.getResources().getColor(R.color.dg_systemui_theme_color_accent);
            mColorDisabled = context.getResources().getColor(R.color.dg_systemui_theme_color_inactive);
            mColorInactive = context.getResources().getColor(R.color.dg_systemui_theme_color_inactive);
            //add for TEJWQE-424 by liyuchong 20200402 begin
        }else if (SystemUIApplication.useBluCustomUI){
            mColorActive = context.getResources().getColor(R.color.cyee_color_accent);
            mColorDisabled = Utils.getDisabled(context,
                    Utils.getColorAttrDefaultColor(context, android.R.attr.textColorTertiary));
            mColorInactive = Utils.getColorAttrDefaultColor(context, android.R.attr.textColorSecondary);

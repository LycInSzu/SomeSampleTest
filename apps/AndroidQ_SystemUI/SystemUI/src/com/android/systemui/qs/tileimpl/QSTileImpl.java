...
//                return Utils.getColorAttrDefaultColor(context, android.R.attr.colorPrimary);
            case Tile.STATE_UNAVAILABLE:
                return SystemUIApplication.useDgCustomUI ? context.getResources().getColor(R.color.dg_systemui_theme_color_unavailable) : Utils.getDisabled(context,
                        Utils.getColorAttrDefaultColor(context, android.R.attr.textColorSecondary));
            case Tile.STATE_INACTIVE:
                return SystemUIApplication.useDgCustomUI ? context.getResources().getColor(R.color.dg_systemui_theme_color_inactive) : Utils.getColorAttrDefaultColor(context, android.R.attr.textColorSecondary);
            case Tile.STATE_ACTIVE:
                return SystemUIApplication.useDgCustomUI ? context.getResources().getColor(R.color.dg_systemui_theme_color_accent) : SystemUIApplication.useBluCustomUI ? context.getResources().getColor(R.color.cyee_color_accent) : Utils.getColorAttrDefaultColor(context, android.R.attr.colorPrimary);

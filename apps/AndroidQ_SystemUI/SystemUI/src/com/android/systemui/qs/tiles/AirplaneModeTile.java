...
public class AirplaneModeTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(airplaneMode ? R.drawable.ic_airplane_on : R.drawable.ic_airplane_off);
        }else if (SystemUIApplication.useBluCustomUI){
            state.icon = ResourceIcon.get(R.drawable.ic_qs_airplane_blu);
        }else {
            state.icon = mIcon;
        }

...
public class BatterySaverTile extends QSTileImpl<BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.state == Tile.STATE_ACTIVE ? R.drawable.ic_battery_saver_on : state.state == Tile.STATE_UNAVAILABLE ? R.drawable.ic_battery_saver_disable : R.drawable.ic_battery_saver_off);
        } else {
            state.icon = mIcon;
        }

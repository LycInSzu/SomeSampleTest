...
public class BluetoothTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.state != Tile.STATE_INACTIVE ? R.drawable.ic_bluetooth_on : R.drawable.ic_bluetooth_off);
        }else if (SystemUIApplication.useBluCustomUI) {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_bluetooth_blu);
        }

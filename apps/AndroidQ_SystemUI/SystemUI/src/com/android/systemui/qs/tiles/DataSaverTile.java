...
public class DataSaverTile extends QSTileImpl<BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.value ? R.drawable.ic_data_server_on : R.drawable.ic_data_server_off);
        }else if(SystemUIApplication.useBluCustomUI){
            state.icon = ResourceIcon.get(R.drawable.ic_data_saver_blu);
        }else {
            state.icon = ResourceIcon.get(state.value ? R.drawable.ic_data_saver
                    : R.drawable.ic_data_saver_off);
        }

...
public class DndTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.state == Tile.STATE_ACTIVE ? R.drawable.ic_dnd_on : R.drawable.ic_dnd_off);
        } else if(SystemUIApplication.useBluCustomUI){
            state.icon = ResourceIcon.get(R.drawable.ic_qs_dnd_blu);
        }else {
            state.icon = ResourceIcon.get(com.android.internal.R.drawable.ic_qs_dnd);
        }

...
public class HotspotTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(!state.slash.isSlashed ? R.drawable.ic_hotspot_on : R.drawable.ic_hotspot_off);
        }else if(SystemUIApplication.useBluCustomUI){
            state.icon = ResourceIcon.get(R.drawable.ic_hotspot_blu);
        }

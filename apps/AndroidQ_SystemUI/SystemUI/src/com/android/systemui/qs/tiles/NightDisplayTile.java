...
public class NightDisplayTile extends QSTileImpl<BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.value ? R.drawable.ic_night_light_on : R.drawable.ic_night_light_off);
        }else if(SystemUIApplication.useBluCustomUI){
            state.icon = ResourceIcon.get(R.drawable.ic_qs_night_display);
        }else {
            state.icon = ResourceIcon.get(com.android.internal.R.drawable.ic_qs_night_display_on);
        }

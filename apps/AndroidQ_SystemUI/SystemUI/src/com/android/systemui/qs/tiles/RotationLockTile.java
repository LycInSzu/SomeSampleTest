...
public class RotationLockTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (SystemUIApplication.useDgCustomUI||SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(!rotationLocked ? R.drawable.ic_auto_rotate_on : R.drawable.ic_auto_rotate_off);
        } else if (SystemUIApplication.useBluCustomUI) {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_auto_rotate);
        } else {
            state.icon = mIcon;
        }

...
public class UiModeNightTile extends QSTileImpl<QSTile.BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        //add for TEJBB-60 by liyuchong 20200228 begin
        if (SystemUIApplication.useDkCustomUI) {
            state.icon = ResourceIcon.get(state.state == Tile.STATE_ACTIVE ? R.drawable.ic_darkmode_on : R.drawable.ic_darkmode_off);
        }
        //add for TEJBB-60 by liyuchong 20200228 end

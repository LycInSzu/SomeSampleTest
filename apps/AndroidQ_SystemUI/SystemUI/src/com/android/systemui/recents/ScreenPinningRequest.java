...
//add for BUG_ID:E937_YJSQ-3991 by yuchong.li@wheatek.com 20190522 begin
import android.provider.Settings;
import android.os.SystemProperties;
//add for BUG_ID:E937_YJSQ-3991 by yuchong.li@wheatek.com 20190522 end
public class ScreenPinningRequest implements View.OnClickListener,
    ...
    //add by wangjian for XWYYQ-79 20191218 start
    private IWindowManager mWindowManagerService;
    //add by wangjian for XWYYQ-79 20191218 end
    ...
    private class RequestWindowView extends FrameLayout {
        ...
        private void inflateView(int rotation) {
            ...
            //modified for BUG_ID:E937_YJSQ-3991 by yuchong.li@wheatek.com 20190522 begin
...
//smart navigation is not exit now
//            if (SystemProperties.getBoolean("ro.odm_smart_navibar_support", false)) {
//                int navibarStyle = android.provider.Settings.System.getInt(mContext.getContentResolver(),
//                        Settings.System.SMART_NAVIGATION_BAR_STYLE, 0);
//
//                if ((navibarStyle == 0) || (navibarStyle == 2)) {
//                    mLayout = (ViewGroup) View.inflate(getContext(),
//                            rotation == ROTATION_SEASCAPE ? R.layout.screen_pinning_request_sea_phone :
//                                    rotation == ROTATION_LANDSCAPE ? R.layout.screen_pinning_request_land_phone
//                                            : R.layout.screen_pinning_request, null);
//                } else {
//                    mLayout = (ViewGroup) View.inflate(getContext(),
//                            rotation == ROTATION_SEASCAPE ? R.layout.screen_pinning_request_sea_phone_navi_revert :
//                                    rotation == ROTATION_LANDSCAPE ? R.layout.screen_pinning_request_land_phone_navi_revert
//                                            : R.layout.screen_pinning_request_navi_revert, null);
//                }
//            } else {
                String navbarLayout = mContext.getString(R.string.config_navBarLayout);
                if (navbarLayout.indexOf("back") < navbarLayout.indexOf("recent")) {
                    mLayout = (ViewGroup) View.inflate(getContext(),
                            rotation == ROTATION_SEASCAPE ? R.layout.screen_pinning_request_sea_phone :
                                    rotation == ROTATION_LANDSCAPE ? R.layout.screen_pinning_request_land_phone
                                            : R.layout.screen_pinning_request, null);
...
//            }
            //modified for BUG_ID:E937_YJSQ-3991 by yuchong.li@wheatek.com 20190522 end
            ...
            //add by wangjian for XWYYQ-79 20191218 start
            try {
                if (!mWindowManagerService.hasNavigationBar(getContext().getDisplayId())) {
                    Log.d("ScreenPinningRequest","No navigationbar, show unpin description as physical key");
                    descriptionStringResId = R.string.screen_pinning_description_physical_key;
                }
            } catch (RemoteException e) {

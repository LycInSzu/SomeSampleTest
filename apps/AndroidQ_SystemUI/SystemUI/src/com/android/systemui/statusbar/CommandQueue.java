...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_RELOAD_NAVIGATIONBAR = 48 << MSG_SHIFT;
    private static final int MSG_REMOVE_NAVIGATIONBAR = 49 << MSG_SHIFT;
    ...
    public interface Callbacks {
        ...
        // add by wangjian for TEJWQE-414 20200331 start
        default void reloadNavigationBar() { }
        default void removeNavigationBar() { }
        // add by wangjian for TEJWQE-414 20200331 end
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_RELOAD_NAVIGATIONBAR:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).reloadNavigationBar();
                    }
                    break;
                case MSG_REMOVE_NAVIGATIONBAR:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).removeNavigationBar();
                    }
                    break;
                // add by wangjian for TEJWQE-414 20200331 end
            }

...
public class EmptyShadeView extends StackScrollerDecorView {
    ...
    public void setTextColor(@ColorInt int color) {
        ...
        //add by wangjian for YJSQ-1098 20181214 start
        setShadowLayerColor(color);
        //add by wangjian for YJSQ-1098 20181214 end
    }
    ...
    private void setShadowLayerColor(int color) {
        ...
        mEmptyText.setShadowLayer(2f,0,0, inverseColor);
    }
    //add by wangjian for YJSQ-1098 20181214 end
    ...
    protected void onFinishInflate() {
        ...
        //add by wangjian for YJSQ-1098 20181214 start
        setShadowLayerColor(mEmptyText.getCurrentTextColor());
        //add by wangjian for YJSQ-1098 20181214 end
    }

...
public class KeyguardIndicationController implements StateListener,
    ...
    //add by liyuchong for TELLB-297 20200218 begin
    private boolean mRemoveSlowChargingIndicator = false;
    //add by liyuchong for TELLB-297 20200218 end
    //add for TEJWQ-184 by liyuchong 20200326 begin
    private boolean mShowRemainingChargingTime = true;
    //add for TEJWQ-184 by liyuchong 20200326 end
    ...
    KeyguardIndicationController(Context context, ViewGroup indicationArea, LockIcon lockIcon,
        ...
        //add by liyuchong for TELLB-297 20200218 begin
        mRemoveSlowChargingIndicator = mContext.getResources().getBoolean(R.bool.config_remove_slow_charging_indicator);
        //add by liyuchong for TELLB-297 20200218 end
        //add for TEJWQ-184 by liyuchong 20200326 begin
        mShowRemainingChargingTime = mContext.getResources().getBoolean(R.bool.config_show_remainingchargingtime_in_keyguard);
        //add for TEJWQ-184 by liyuchong 20200326 end
    }
    ...
    private String computePowerIndication() {
        ...
        //modify for TEJWQ-184 by liyuchong 20200326 begin
        //final boolean hasChargingTime =chargingTimeRemaining > 0;
        final boolean hasChargingTime =mShowRemainingChargingTime && chargingTimeRemaining > 0;
        //modify for TEJWQ-184 by liyuchong 20200326 end
        int chargingId;
        if (mPowerPluggedInWired) {
            switch (mChargingSpeed) {
                ...
                case KeyguardUpdateMonitor.BatteryStatus.CHARGING_SLOWLY:
                    ...
                    //add by liyuchong for TELLB-297 20200218 begin
                    if(mRemoveSlowChargingIndicator) {
    ...
    protected class BaseKeyguardCallback extends KeyguardUpdateMonitorCallback {
        ...
        //add for EJQQ-1078 by liyuchong 20191101 begin
        private int mOldFpMsgId=-1;
        //add for EJQQ-1078 by liyuchong 20191101 end
        ...
        public void onBiometricError(int msgId, String errString,
            ...
            if (FaceUnlockUtil.isFaceUnlockSupport()) {
                FaceUnlockUtil.getInstance().setFingerprintLocked(msgId);
            }
            //FACE_UNLOCK_SUPPORT end
            ...
            if (mStatusBarKeyguardViewManager.isBouncerShowing()) {
                ...
                //modify for EJQQQ-592 by liyuchong 20200227 begin
                //showTransientIndication(errString);
                showTransientIndication(errString, Utils.getColorError(mContext));
                //modify for EJQQQ-592 by liyuchong 20200227 end
        ...
        private boolean shouldSuppressFingerprintError(int msgId,
            ...
            //add for EJQQ-1078 by liyuchong 20191101 begin
            if (mStatusBarKeyguardViewManager.isBouncerShowing()&&(msgId==FingerprintManager.FINGERPRINT_ERROR_LOCKOUT_PERMANENT || msgId==FingerprintManager.FINGERPRINT_ERROR_LOCKOUT)&&(mOldFpMsgId==msgId)){
                mOldFpMsgId=msgId;
                return true;
            }
            mOldFpMsgId=msgId;
        ...
        //add for EJQQQ-592 by liyuchong 20200227 begin
        @Override
        public void onScreenTurnedOff() {
            mOldFpMsgId=-1;
        }
        //add for EJQQQ-592 by liyuchong 20200227 end

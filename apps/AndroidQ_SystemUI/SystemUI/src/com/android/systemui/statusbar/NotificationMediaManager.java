...
//add BUG_ID:ABLJ-188 liuzhijun 20181030 (start)
import android.content.res.Resources;
import com.android.systemui.R;
import android.app.WallpaperManager;
import java.io.BufferedInputStream;
import java.io.IOException;
//add BUG_ID:ABLJ-188 liuzhijun 20181030 (end)
...
public class NotificationMediaManager implements Dumpable {
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (artworkBitmap != null) {
            //modify for TEWBW-703 by liyuchong 20200107 begin
...
//                    allowEnterAnimation).execute(artworkBitmap));
            ...
            //modify for TEWBW-703 by liyuchong 20200107 end
        } else {
    ...
    private void finishUpdateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation,
        ...
        if (ENABLE_LOCKSCREEN_WALLPAPER && artworkDrawable == null) {
            ...
            //add BUG_ID:ABLJ-188 liuzhijun 20181030 (start)
                ...
                //if(mContext.getResources().getBoolean(R.bool.config_set_lockwallpaper)){
                WallpaperManager wallpaperManager = WallpaperManager.getInstance(mContext);
                if (wallpaperManager.getHomeWallpaperOnly()){
                    Resources resources = mContext.getResources();
                    try {
                        if ( mContext.getResources().getBoolean(R.bool.config_set_def_keyguard_wallpaper) ){
                            wallpaperManager.setStream(new BufferedInputStream(
                                                             resources.openRawResource(
                                                             resources.getSystem()
                                                             .getIdentifier("keyguard_wallpaper", "drawable", "android"))),
                            ...
                            wallpaperManager.setStream(new BufferedInputStream(
                                                             resources.openRawResource(
                                                             resources.getSystem()
                                                             .getIdentifier("default_wallpaper", "drawable", "android"))),
                                                             null, true, WallpaperManager.FLAG_LOCK);
                        }
                    } catch (IOException e) {
        ...
        if ((hasArtwork || DEBUG_MEDIA_FAKE_ARTWORK)
            ...
            if (metaDataChanged) {
                ...
                if (DEBUG_MEDIA_FAKE_ARTWORK) {
                    ...
                    //add for TEWBW-703 by liyuchong 20200107 begin
                    mBackdropBack.setBackgroundColor(0xFF000000);
                    //add for TEWBW-703 by liyuchong 20200107 end

...
public class NotificationData {
    ...
    protected final Comparator<NotificationEntry> mRankingComparator =
        ...
        public int compare(NotificationEntry a, NotificationEntry b) {
            ...
            boolean aDKUsual = aHeadsUp || a.isHighPriority();
            boolean bDKUsual = bHeadsUp || b.isHighPriority();
...
//            b.setIsTopBucket(bHeadsUp || bMedia || bSystemMax || b.isHighPriority());
            if (SystemUIApplication.dkModifyNotiSortLogic && !SystemUIApplication.isInCtsNotificationTest()){
...
//                && mTmpRanking.getImportance() >= NotificationManager.IMPORTANCE_LOW;
        return notification.isForegroundService()
                && ((SystemUIApplication.dkModifyNotiSortLogic && !SystemUIApplication.isInCtsNotificationTest()) ?(mTmpRanking.getImportance() >= NotificationManager.IMPORTANCE_DEFAULT):(mTmpRanking.getImportance() >= NotificationManager.IMPORTANCE_LOW));
        //modify for EWSWQ-50 by liyuchong 20200116 end
    }

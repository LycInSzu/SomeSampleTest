...
public class FooterView extends StackScrollerDecorView {
    ...
    protected void onFinishInflate() {
        ...
        //add by wangjian for YJSQ-1097 20181214 start
        setShadowLayerColor(mManageButton.getCurrentTextColor());
        //add by wangjian for YJSQ-1097 20181214 end
    }
    ...
    public void setTextColor(@ColorInt int color) {
        ...
        //add by wangjian for YJSQ-1097 20181214 start
        setShadowLayerColor(color);
        //add by wangjian for YJSQ-1097 20181214 end
    }

    //add by wangjian for YJSQ-1097 20181214 start
    private void setShadowLayerColor(int color) {
        int red = 255 - Color.red(color);
        int green = 255 - Color.green(color);
        int blue = 255 - Color.blue(color);
        int inverseColor = Color.rgb(red, green, blue);
        mManageButton.setShadowLayer(2f,0,0, inverseColor);
        mDismissButton.setShadowLayer(2f,0,0, inverseColor);
    }
    //add by wangjian for YJSQ-1097 20181214 end

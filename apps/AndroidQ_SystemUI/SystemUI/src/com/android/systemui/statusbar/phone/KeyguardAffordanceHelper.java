...
public class KeyguardAffordanceHelper {
    ...
    private static final String TAG = "KeyguardAffordanceHelpe";
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (FaceUnlockUtil.isFaceUnlockSupport()) {
                    ...
                    //处理上划解锁界面的图标点击事件
                    if(FaceUnlockUtil.getInstance().isIsBouncerShow()&&FaceUnlockUtil.getInstance().startFaceUnlockByRetry(FaceUnlockUtil.FACE_UNLOCK_RETRY_IN_KEYGUARD)) {
                    }
                }
                //FACE_UNLOCK_SUPPORT end

...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    private class DefaultLeftButton implements IntentButton {
        ...
        public IconState getIcon() {
            //modify for EWSWQ-40 by liyuchong 20200113 begin
            //mLeftIsVoiceAssist = canLaunchVoiceAssist();
            mLeftIsVoiceAssist = canLaunchVoiceAssist() && !(2==SystemProperties.getInt("persist.sys.odm_keyguard_leftbutton_function", 0));
            //modify for EWSWQ-40 by liyuchong 20200113 end
            ...
            if (mLeftIsVoiceAssist) {
                ...
                //add for EWSWQ-377 by liyuchong 20200306 begin
                if (SystemUIApplication.useDkCustomUI){
                    mIconState.drawable = mContext.getDrawable(R.drawable.ic_phone_dk);
                }
                //add for EWSWQ-377 by liyuchong 20200306 end
                mIconState.contentDescription = mContext.getString(
    ...
    private class DefaultRightButton implements IntentButton {
        ...
        public IconState getIcon() {
            ...
            //add for EJQQQ-76 by liyuchong 20191202 begin
            if (SystemUIApplication.useDgCustomUI){
                mIconState.drawable = mContext.getDrawable(R.drawable.ic_camera_alt_26dp_dg);
            }
            //add for EJQQQ-76 by liyuchong 20191202 end

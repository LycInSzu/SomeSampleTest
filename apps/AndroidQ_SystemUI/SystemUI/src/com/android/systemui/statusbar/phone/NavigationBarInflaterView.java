...
public class NavigationBarInflaterView extends FrameLayout
    ...
    //add BugID:YJSQ-1838 gaoshan 20190104 start
    public static final String LEFT_SPACE = "left_space";
    //add BugID:YJSQ-1838 gaoshan 20190104 end
    ...
    public static final String NOTIFICATION_CONTROL = "notification_panel_control";
    private static final boolean mSmartNavibarSupport =
            android.os.SystemProperties.getBoolean("ro.odm_smart_navibar_support", false);
    private static final boolean mSmartNavibarNotificationSupport =
            android.os.SystemProperties.getBoolean("ro.odm_smart_navibar_notification_support", false);
    ...
    protected String getDefaultLayout() {
        ...
        if (!mSmartNavibarSupport || QuickStepContract.isGesturalMode(mNavBarMode)) {
            return getContext().getString(defaultResource);
        } else {
            String navbarLayout = mContext.getString(R.string.config_navBarLayout);
            navbarLayout = navbarLayout.replace(LEFT_SPACE, NAVIGATIONBAR);
            if (mSmartNavibarNotificationSupport) {
                navbarLayout = navbarLayout.replace(RIGHT, NOTIFICATION_CONTROL);
            }
            return navbarLayout;
        }
        //modify by liulei for Smart navigation bar 20180418 end
    }
    ...
    private void updateAlternativeOrder() {
        ...
        if (!mSmartNavibarSupport || QuickStepContract.isGesturalMode(mNavBarMode)) {
            ...
            updateAlternativeOrder(mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            updateAlternativeOrder(mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.center_group));
            updateAlternativeOrder(mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            updateAlternativeOrder(mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.center_group));
            updateAlternativeOrder(mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));
            updateAlternativeOrder(mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group));
            updateAlternativeOrder(mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));
            updateAlternativeOrder(mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group));
        }
    ...
    private void initiallyFill(ButtonDispatcher buttonDispatcher) {
        ...
        if (!mSmartNavibarSupport || QuickStepContract.isGesturalMode(mNavBarMode)) {
            ...
            addAll(buttonDispatcher, mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            addAll(buttonDispatcher, mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.center_group));
            addAll(buttonDispatcher, mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));
            addAll(buttonDispatcher, mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group));
            addAll(buttonDispatcher, mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            addAll(buttonDispatcher, mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.center_group));
            addAll(buttonDispatcher, mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));
            addAll(buttonDispatcher, mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group));
        }
        //modify by wangjian for TEJWQE-414 20200331 start
    }
    ...
    protected void inflateLayout(String newLayout) {
        ...
        */
        if (!mSmartNavibarSupport || QuickStepContract.isGesturalMode(mNavBarMode)) {
            ...
            String[] start2 = new String[start.length];
            start2[0] = start[0];
            start2[1] = end[0];
            String[] end2 = new String[end.length];
            end2[0] = start[1];
            end2[1] = end[1];
            inflateButtons(start, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group), false,true);
            inflateButtons(start2, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group), false,true);
            inflateButtons(start, (ViewGroup) mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group), true,true);
            inflateButtons(start2, (ViewGroup) mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group), true,true);

            inflateButtons(center, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.center_group), false, false);
            inflateButtons(center, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group), false, false);
            inflateButtons(center, (ViewGroup) mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.center_group), true, false);
            inflateButtons(center, (ViewGroup) mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.center_group), true, false);

            addGravitySpacer((LinearLayout) mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            addGravitySpacer((LinearLayout) mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));
            addGravitySpacer((LinearLayout) mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group));
            addGravitySpacer((LinearLayout) mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group));

            inflateButtons(end, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group), false,false);
            inflateButtons(end2, (ViewGroup) mHorizontal.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group), false,false);
            inflateButtons(end, (ViewGroup) mVertical.findViewById(R.id.nav_buttons).findViewById(R.id.ends_group), true,false);
            inflateButtons(end2, (ViewGroup) mVertical.findViewById(R.id.nav_buttons_two).findViewById(R.id.ends_group), true,false);
        }
    ...
    protected View inflateButton(String buttonSpec, ViewGroup parent, boolean landscape,
        ...
        //add by wangjian for TEJWQE-414 20200331 start
        if("".equals(buttonSpec) || buttonSpec == null || buttonSpec.length() == 0) return null;
        //add by wangjian for TEJWQE-414 20200331 end
    ...
    private View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        if (HOME.equals(button)) {
            ...
            //add BugID:YJSQ-1838 gaoshan 20190104 start
        } else if (LEFT_SPACE.equals(button)) {
            v = inflater.inflate(R.layout.nav_key_space_left, parent, false);
            //add BugID:YJSQ-1838 gaoshan 20190104 end
        }
        //add by wangjian for TEJWQE-414 20200331 start
        else if (NAVIGATIONBAR.equals(button)) {
            v = inflater.inflate(R.layout.navigationbar, parent, false);
        } else if (NOTIFICATION_CONTROL.equals(button)) {
            v = inflater.inflate(R.layout.notification_panel_control, parent, false);
        }
        //add by wangjian for TEJWQE-414 20200331 end
    ...
    private void clearViews() {
        ...
        //add by wangjian for TEJWQE-414 20200331 start
        if (mSmartNavibarSupport && !QuickStepContract.isGesturalMode(mNavBarMode)) {
            clearAllChildren(mHorizontal.findViewById(R.id.nav_buttons_two));
            clearAllChildren(mVertical.findViewById(R.id.nav_buttons_two));
        }
        //add by wangjian for TEJWQE-414 20200331 end
    }

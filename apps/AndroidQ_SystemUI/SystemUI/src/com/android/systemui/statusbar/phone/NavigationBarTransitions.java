...
public final class NavigationBarTransitions extends BarTransitions implements
        ...
        mView.addOnLayoutChangeListener(
                (v, left, top, right, bottom, oldLeft, oldTop, oldRight, oldBottom) -> {
                    ...
                    if (currentView != null) {
                        ...
                        // add by wangjian for TEJWQE-414 20200331 start
                        mNavButtionsTwo = currentView.findViewById(R.id.nav_buttons_two);
                        // add by wangjian for TEJWQE-414 20200331 end
    ...
    private void applyLightsOut(boolean lightsOut, boolean animate, boolean force) {
        ...
        if (!animate) {
            ...
            // add by wangjian for TEJWQE-414 20200331 start
            mNavButtionsTwo.setAlpha(navButtonsAlpha);
            // add by wangjian for TEJWQE-414 20200331 end
        } else {

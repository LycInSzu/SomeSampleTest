        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (isFullyCollapsed() && !mHeadsUpManager.hasPinnedHeadsUp()
                    ...
                    //delete by wangjian for TEWBW-1239 20200317 start
                    //startOpening();
                    //delete by wangjian for TEWBW-1239 20200317 end
                }
                break;
...
//        delete for EJQQ-1073 by liyuchong 20191101 begin
//        if (mFalsingManager.isClassiferEnabled()) {
//            return mFalsingManager.isFalseTouch();
//        }
//        delete for EJQQ-1073 by liyuchong 20191101 end

...
public class PhoneStatusBarPolicy
    ...
    private final void updateBluetooth() {
        //modify by wangjian for EJQQ-980 20191023 start
        //int iconId = R.drawable.stat_sys_data_bluetooth_connected;
        int iconId = R.drawable.stat_sys_data_bluetooth;
        //modify by wangjian for EJQQ-980 20191023 end
        String contentDescription =
                mContext.getString(R.string.accessibility_quick_settings_bluetooth_on);
        boolean bluetoothVisible = false;
        //add by wangjian for EJQQ-980 20191023 start
        bluetoothVisible = mBluetooth.isBluetoothEnabled();
        //add by wangjian for EJQQ-980 20191023 end
        if (mBluetooth != null) {
            if (mBluetooth.isBluetoothConnected()) {
                ...
                //delete by wangjian for EJQQ-980 20191023 start
                //bluetoothVisible = mBluetooth.isBluetoothEnabled();
                //delete by wangjian for EJQQ-980 20191023 end
            }
        }

 ...
 */
//modify for EJQQ-1888 by liyuchong 20191206 begin
// public class ScreenPinningNotify {
public class ScreenPinningNotify implements NavigationModeController.ModeChangedListener {
//modify for EJQQ-1888 by liyuchong 20191206 end
    ...
    //add for EJQQ-1888 by liyuchong 20191206 begin
    private int mNavBarMode;
    //add for EJQQ-1888 by liyuchong 20191206 end
    ...
    public void showEscapeToast(boolean isRecentsButtonVisible) {
        ...
        mLastToast = makeAllUserToastAndShow(isRecentsButtonVisible
                ...
                ? R.string.screen_pinning_toast_gestural
                : R.string.screen_pinning_toast_recents_invisible);
         //modify for EJQQ-1888 by liyuchong 20191206 end

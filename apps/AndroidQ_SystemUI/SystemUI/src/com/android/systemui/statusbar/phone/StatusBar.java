...
//add BUG_ID:TBSW-52 liuzhijun 20180307 (start)
import android.hardware.Sensor;
import android.hardware.SensorEvent;
import android.hardware.SensorEventListener;
import android.hardware.SensorManager;
//add BUG_ID:TBSW-52 liuzhijun 20180307 (end)
...
import com.android.systemui.screenshot.NewLongScreenUtil;
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    //add for EJWJ-1056 by liyuchong 20191012 begin
    public static boolean showAutoBrightnessIcon=false;
    //add for EJWJ-1056 by liyuchong 20191012 end

    //add for TEJWQE-531 by liyuchong 20200403 begin
    public static boolean isInExtremeMode=false;
    //add for TEJWQE-531 by liyuchong 20200403 end
    /**
    ...
    //add for XWYYQ-342 by liyuchong 20200114 begin
    public static  boolean isScreenTurnningOn=false;
    //add for XWYYQ-342 by liyuchong 20200114 end
    ...
    // add BUG_ID:TEWBW-1062 chenyu 20200319 start
    private KeyguardSecurityModel mSecurityModel;
    private KeyguardSecurityModel.SecurityMode mSecurityMode;
    // add BUG_ID:TEWBW-1062 chenyu 20200319 end
    ...
    //add by wangjian for liuhai 20181228 start
    public static boolean isLiuhaiSupport = false;
    public static boolean showNotificationIconInQs = true;
    public static boolean isNeedChangeStatusbarIconForLiuhai = false;
    //add by wangjian for liuhai 20181228 end
    ...
    public void start() {
        //add for TEJWQE-531 by liyuchong 20200403 begin
        mHelper = Dependency.get(Dependency.EXTREME_MODE_HELPER);
        //add for TEJWQE-531 by liyuchong 20200403 end
        //add BUG_ID:TBSW-52 liuzhijun 20180307 (start)
        ...
        mNavigationBarController.setStatusBar(this);
        ...
        //add for EJWJ-1056 by liyuchong 20191012 begin
        showAutoBrightnessIcon = res.getBoolean(R.bool.show_auto_brightness);
        //add for EJWJ-1056 by liyuchong 20191012 end
        //add by wangjian for liuhai 20181228 start
        isLiuhaiSupport = res.getBoolean(com.android.internal.R.bool.config_fillMainBuiltInDisplayCutout);
        Log.e("wangjian","isLiuhaiSupport = " + isLiuhaiSupport);
        //add by wangjian for liuhai 20181228 end
        //add by wangjian for YJSQ-3180 20190401 start
        mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.DATE_FORMAT), false, mDateFormatOberver);
        //add by wangjian for YJSQ-3180 20190401 end
        ...
        //add by wangjian for XWYYQ-73 20191213 start
        try {
        ...
        //add by wangjian for XWYYQ-73 20191213 end
        ...
        //add for TEJWQE-531 by liyuchong 20200403 begin
        mHelper.addCallback(mECallback);
        //add for TEJWQE-531 by liyuchong 20200403 end
    ...
    public void onThemeChanged() {
        ...
        if (FaceUnlockUtil.isFaceUnlockSupport()) {
            ...
            FaceUnlockUtil.getInstance().setLockIcon(mStatusBarWindow.findViewById(R.id.lock_icon));
        }
        //FACE_UNLOCK_SUPPORT end
    }
    ...
    private void updateQsExpansionEnabled() {
        //add for TEJWQE-531 by liyuchong 20200403 begin
        if(mHelper!=null && mHelper.isExtremeMode()) return;
        //add for TEJWQE-531 by liyuchong 20200403 end
    ...
    public void disable(int displayId, int state1, int state2, boolean animate) {
        ...
        mDisabled1 = state1;
        // add by wangjian for TEJWQE-414 20200331 start
        mNavigationBarController.setDisableFlags(mDisabled1);
        // add by wangjian for TEJWQE-414 20200331 end
...
///@}
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                //add for XWYYQ-105 by liyuchong 20191219 begin
                if (!mLaunchTransitionTimeoutFinished){
                    onLaunchTransitionTimeout();
                }
                //add for XWYYQ-105 by liyuchong 20191219 end
            }
            else if (DevicePolicyManager.ACTION_SHOW_DEVICE_MONITORING_DIALOG.equals(action)) {
                mQSPanel.showDeviceMonitoringDialog();
            //add for TEWSL-399 by liyuchong 20200109 begin
            } else if(action.equals(ACTION_LS_RUNNING_START)){
    ...
    public void fadeKeyguardAfterLaunchTransition(final Runnable beforeFading,
        ...
        //add for XWYYQ-105 by liyuchong 20191219 begin
        mLaunchTransitionTimeoutFinished = true;
        //add for XWYYQ-105 by liyuchong 20191219 end
        mHandler.removeMessages(MSG_LAUNCH_TRANSITION_TIMEOUT);
    ...
    public void startLaunchTransitionTimeout() {
        //add for XWYYQ-105 by liyuchong 20191219 begin
        mLaunchTransitionTimeoutFinished = false;
        //add for XWYYQ-105 by liyuchong 20191219 end
        //modify for XWYYQ-210 by liyuchong 20191220 begin
//        mHandler.sendEmptyMessageDelayed(MSG_LAUNCH_TRANSITION_TIMEOUT,
//                LAUNCH_TRANSITION_TIMEOUT_MS);
        if (ActivityManager.isLowRamDeviceStatic()){
            mHandler.sendEmptyMessageDelayed(MSG_LAUNCH_TRANSITION_TIMEOUT,
                    LAUNCH_TRANSITION_TIMEOUT_MS+2000L);
        }else {
            mHandler.sendEmptyMessageDelayed(MSG_LAUNCH_TRANSITION_TIMEOUT,
                    LAUNCH_TRANSITION_TIMEOUT_MS);
        }
        //modify for XWYYQ-210 by liyuchong 20191220 end

    }

    //add for XWYYQ-105 by liyuchong 20191219 begin
    private static boolean mLaunchTransitionTimeoutFinished = true;
    //add for XWYYQ-105 by liyuchong 20191219 end
    ...
    final WakefulnessLifecycle.Observer mWakefulnessObserver = new WakefulnessLifecycle.Observer() {
        ...
        public void onStartedWakingUp() {
            //add BUG_ID:TBSW-52 liuzhijun 20180307 (start)
			boolean mTeleMotionEnable =
					Settings.System.getInt(mContext.getContentResolver(),
							Settings.System.WTK_TELE_MOVTION_ENABLE, 0) != 0;
            
            // add BUG_ID:TEWBW-1062 chenyu 20200319 start
            mSecurityModel = new KeyguardSecurityModel(mContext);
            mSecurityMode = mSecurityModel.getSecurityMode(KeyguardUpdateMonitor.getCurrentUser());
            // add BUG_ID:TEWBW-1062 chenyu 20200319 end
            
			if ((Settings.System.getInt(
					mContext.getContentResolver(), Settings.System.SMARTMOVTION_SMARTUNLOCK, 0) == 1
					&& mSensorManager != null)
					&& mTeleMotionEnable
                    // add BUG_ID:TEWBW-1062 chenyu 20200319 start
                    && mSecurityMode == KeyguardSecurityModel.SecurityMode.None) {
                    // add BUG_ID:TEWBW-1062 chenyu 20200319 end
				Log.i(TAG, "registerListener mSensorEventListener");
    ...
    public void onCameraLaunchGestureDetected(int source) {
        ...
        //FACE_UNLOCK_SUPPORT start
        if (FaceUnlockUtil.isFaceUnlockSupport() && FaceUnlockUtil.getInstance().startCamera(source)) {
    ...
    SensorEventListener mSensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            //modify BUG_ID:XLLLJ-3545 hu.liu 20161025 (start)
            //if (distance == 1.0) {
            if (x == 1.0 || x == 10.0) {
                //modify BUG_ID:XLLLJ-3545 hu.liu 20161025 (end)
                endTime = System.currentTimeMillis();
                Log.d(TAG, "endTime = " + endTime);
                if ((startTime > 0.0) && (endTime > 0.0) && ((endTime - startTime) > 0) && ((endTime - startTime) < 1000)
                        //debuid:TWJY-841 add by chenxuanyu start
                        &&mPowerManager.isScreenOn()
                    //debuid:TWJY-841 add by chenxuanyu end
                        ) {
                    showBouncer(true);
                    hideKeyguard();
    ...
    //add BUG_ID:TBSW-52 liuzhijun 20180307 (end)
    //add by wangjian for YJSQ-3180 20190401 start
    private ContentObserver mDateFormatOberver = new ContentObserver(mHandler) {
        @Override
    ...
    //add for TEJWQE-531 by liyuchong 20200403 begin
    private ExtremeModeHelper mHelper;
    final ExtremeModeHelper.Callback mECallback = isExtremeMode -> mHandler.post(() -> setQsOverscrollExpansionEnabled(!isExtremeMode));
    private void setQsOverscrollExpansionEnabled(boolean enabled){
        isInExtremeMode = !enabled;

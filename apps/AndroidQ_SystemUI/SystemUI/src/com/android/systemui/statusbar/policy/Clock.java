...
//add for TEWSL-148 by liyuchong 20191011 begin
import android.graphics.Color;
import android.util.TypedValue;
//add for TEWSL-148 by liyuchong 20191011 end
...
public class Clock extends TextView implements DemoMode, Tunable, CommandQueue.Callbacks,
    ...
    public Clock(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            //modify for EJQQ-994 by liyuchong 20191024 begin
            /*mAmPmStyle = mStatusBarExt.getClockAmPmStyle(a.getInt(R.styleable.Clock_amPmStyle,
                    AM_PM_STYLE_GONE));*/
            mAmPmStyle = mStatusBarExt.getClockAmPmStyle(a.getInt(R.styleable.Clock_amPmStyle,
                    context.getResources().getInteger(R.integer.am_pm_default_style)));
            //modify for EJQQ-994 by liyuchong 20191024 end
    ...
    public void onDarkChanged(Rect area, float darkIntensity, int tint) {
        ...
        if (!mUseWallpaperTextColor) {
            //modify for TEWSL-148 by liyuchong 20191011 begin
            //setTextColor(mNonAdaptedColor);
            updateClockColor(mNonAdaptedColor);
            //modify for TEWSL-148 by liyuchong 20191011 end
        }
    }
    ...
    public void useWallpaperTextColor(boolean shouldUseWallpaperTextColor) {
        ...
        if (mUseWallpaperTextColor) {
            updateClockColor(Utils.getColorAttr(mContext, R.attr.wallpaperTextColor).getDefaultColor());
        } else {
            updateClockColor(mNonAdaptedColor);
        }
        //modify for TEWSL-148 by liyuchong 20191011 begin
    ...
    //add for TEWSL-148 by liyuchong 20191011 begin
    private void updateClockColor(int color){
        setTextColor(mShowDark?color:mTintColor);
    }

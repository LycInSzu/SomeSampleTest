...
abstract public class SafetyWarningDialog extends SystemUIDialog
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        // M: Bug_id:XWYYQ-456 chenchunyong 20200313 {
        //if (keyCode == KeyEvent.KEYCODE_VOLUME_UP && mNewVolumeUp
        //        && (System.currentTimeMillis() - mShowTime) > KEY_CONFIRM_ALLOWED_AFTER) {
        if (keyCode == KeyEvent.KEYCODE_VOLUME_UP && mNewVolumeUp
                && ((System.currentTimeMillis() - mShowTime) > KEY_CONFIRM_ALLOWED_AFTER && !mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_audio_safe_volume_fcc_certification))) {
        // M: }
            if (com.android.systemui.volume.D.BUG) Log.d(TAG, "Confirmed warning via VOLUME_UP");

...
public class RecentsView extends FrameLayout {
    ...
    //add for EJSLYQ-27 by liyuchong 20191224 begin
    private final int mNavBarHeight;
    //add for EJSLYQ-27 by liyuchong 20191224 end
    ...
    public RecentsView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        //add for EJSLYQ-27 by liyuchong 20191224 begin
        mNavBarHeight = getResources().getDimensionPixelSize(R.dimen.navigation_bar_height);
        //add for EJSLYQ-27 by liyuchong 20191224 end
    ...
    Rect getStackActionButtonBoundsFromStackLayout() {
        ...
        if (LegacyRecentsImpl.getConfiguration().isLowRamDevice) {
            ...
            //modify for EJSLYQ-27 by liyuchong 20191224 begin
//            top = windowRect.height() - (mStackActionButton.getMeasuredHeight()
//                    + mSystemInsets.bottom + mStackActionButton.getPaddingBottom() / 2);
            top = windowRect.height() - (mStackActionButton.getMeasuredHeight()
                    + mSystemInsets.bottom + mStackActionButton.getPaddingBottom() / 2) - ( mNavBarHeight + 10 );
            //modify for EJSLYQ-27 by liyuchong 20191224 end
        } else {
            left = isLayoutRtl()
...
//                    (actionButtonRect.height() - mStackActionButton.getMeasuredHeight()) / 2;
            top = actionButtonRect.top +
                (actionButtonRect.height() - mStackActionButton.getMeasuredHeight()) / 2 - ( mNavBarHeight + 10 );
            //modify for EJSLYQ-27 by liyuchong 20191224 end
        }

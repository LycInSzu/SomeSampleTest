...
//add BugID:EWSY-660 gaoshan 20190114 start
import android.app.ActivityManager;
import android.provider.Settings;
//add BugID:EWSY-660 gaoshan 20190114 end
/**
...
public class KeyguardPasswordView extends KeyguardAbsKeyInputView
    ...
    //add BugID:EWSY-660 gaoshan 20190114 start
    private int encryptionPasswordLenght = 0;
    //add BugID:EWSY-660 gaoshan 20190114 end
    ...
    public KeyguardPasswordView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //add BugID:EWSY-660 gaoshan 20190114 start
        encryptionPasswordLenght =
                Settings.System.getIntForUser(getContext().getContentResolver(),"encryption_password_length",0,ActivityManager.getCurrentUser());
        //add BugID:EWSY-660 gaoshan 20190114 end
    ...
    protected void resetState() {
        ...
        // modify for EJQQ-1180 by liyuchong 20191031 begin
        /*if (mSecurityMessageDisplay != null) {
            mSecurityMessageDisplay.setMessage("");
        }*/
        displayDefaultSecurityMessage();
        // modify for EJQQ-1180 by liyuchong 20191031 end
        final boolean wasDisabled = mPasswordEntry.isEnabled();
        //delete for EJQQ-1430 by liyuchong 20191107 begin
...
//        if (wasDisabled) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                if (isShown() && mPasswordEntry.isEnabled()) {
                    //add for XWYYQ-210 by liyuchong 20191220 begin
                    mPasswordEntry.setText("");
                    //add for XWYYQ-210 by liyuchong 20191220 end
    ...
    //add BugID:EWSY-660 gaoshan 20190114 start
    private void mtkVerifyPasswordAndUnlock() {
        if (!mContext.getResources().getBoolean(R.bool.unlock_without_button_sure)){
            return;
        }
        if(encryptionPasswordLenght != 0 && mPasswordEntry != null && mPasswordEntry.getText() != null
                && encryptionPasswordLenght == mPasswordEntry.getText().length()) {

...
import static com.android.systemui.statusbar.phone.StatusBar.isScreenTurnningOn;
...
public class KeyguardSliceView extends LinearLayout implements View.OnClickListener,
    ...
    private void showSlice() {
        ...
        if (!mHasHeader) {
            ...
            //modify for XWYYQ-342 by liyuchong 20200114 begin
...
//            }
            if (isScreenTurnningOn && mainTitle != null ){
                mTitle.setVisibility(GONE);
            }else {
                mTitle.setText(title);
                if (header.getPrimaryAction() != null
            ...
            //modify for XWYYQ-342 by liyuchong 20200114 end
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child instanceof KeyguardSliceButton) {
                    ...
                    //delete BugID:XLSSW-587 gaoshan 20190312 start
                    //((KeyguardSliceButton) child).setMaxWidth(width / childCount);
                    //delete BugID:XLSSW-587 gaoshan 20190312 end

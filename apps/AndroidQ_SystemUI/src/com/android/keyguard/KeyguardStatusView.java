...
//add for EJQQ-996 by liyuchong 20191024 begin
import android.text.Spannable;
import android.text.SpannableString;
import android.text.style.RelativeSizeSpan;
//add for EJQQ-996 by liyuchong 20191024 end
...
//        modify for EJQQ-996 by liyuchong 20191024 begin
//        static String clockView12;
        static CharSequence clockView12;
//        modify for EJQQ-996 by liyuchong 20191024 end
        ...
        static void update(Context context) {
            ...
            // Use fancy colon.
            clockView24 = clockView24.replace(':', '\uee01');
            clockView12 = clockView12.toString().replace(':', '\uee01');
            // CLDR insists on adding an AM/PM indicator even though it wasn't in the skeleton
            // format.  The following code removes the AM/PM indicator if we didn't want it.
            if (!clockView12Skel.contains("a")) {
                clockView12 = clockView12.toString().replaceAll("a", "").trim();
            }else {
                clockView12=reSizeAmPm(0.4f, clockView12.toString());
            }
            //modify for EJQQ-996 by liyuchong 20191024 end
            cacheKey = key;
        }
         ...
         * 
         */
        public static CharSequence reSizeAmPm(float amPmRatio, String pattern) {
            if (amPmRatio <= 0) {

...
public class QSDetailClipper {
    ...
    public void animateCircularClip(int x, int y, boolean in, AnimatorListener listener) {
        ...
        mAnimator.start();
        //add for TEWBW-446 by liyuchong 20191227 begin
        if (SystemUIApplication.useDgCustomUI && ActivityManager.isLowRamDeviceStatic()) {
            mBackground.showSecondLayer();
        }
        //add for TEWBW-446 by liyuchong 20191227 end
    }

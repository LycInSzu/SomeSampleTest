    ...
    public void updateResources() {
        ...
        if (SystemUIApplication.useDgCustomUI){
            if (mPortraitOrientation){
                setPadding(0, res.getDimensionPixelSize(R.dimen.qs_panel_padding_top)+res.getDimensionPixelSize(R.dimen.qs_footer_height), 0, res.getDimensionPixelSize(R.dimen.qs_panel_padding_bottom));
            }else {

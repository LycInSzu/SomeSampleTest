...
public class KeyguardStatusBarView extends RelativeLayout
    ...
    //add by wangjian for EJSL-877 20190115 start
    private boolean shouldShowMultiUserIcon = true;
    //add by wangjian for EJSL-877 20190115 end

    public KeyguardStatusBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //add by wangjian for EJSL-877 20190115 start
        shouldShowMultiUserIcon = context.getResources().getBoolean(R.bool.should_show_multi_user_icon);
        //add by wangjian for EJSL-877 20190115 end
    }

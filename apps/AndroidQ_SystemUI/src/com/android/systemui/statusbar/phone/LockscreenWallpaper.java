...
//add BUG_ID:none liuzhijun 20181031 (start)
import com.android.systemui.R;
import java.io.BufferedInputStream;
import java.io.IOException;
import android.provider.Settings;
//add BUG_ID:none liuzhijun 20181031 (end)
...
public class LockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable {
    ...
    public Bitmap getBitmap() {
        ...
        //set default lockscreen wallpaper 
        if(mContext.getResources().getBoolean(R.bool.config_set_def_keyguard_wallpaper)){
            if(Settings.System.getInt(mContext.getContentResolver(),"set_def_locksrceen_wallpaper",0) == 0){
                Resources resources = mContext.getResources();
                Settings.System.putInt(mContext.getContentResolver(),"set_def_locksrceen_wallpaper", 1);

                try {
                    mWallpaperManager.setStream(new BufferedInputStream(

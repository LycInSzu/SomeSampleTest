...
public class MultiUserSwitch extends FrameLayout implements View.OnClickListener {
    ...
    //modify for TEWBW-493 by liyuchong 20191231 begin
//    protected UserSwitcherController mUserSwitcherController;
    protected UserSwitcherController mUserSwitcherController = Dependency.get(UserSwitcherController.class);
    //modify for TEWBW-493 by liyuchong 20191231 end
    ...
    //add for TEWBW-493 by liyuchong 20191231 begin
    @Override
    protected void onVisibilityChanged(View changedView, int visibility) {
        super.onVisibilityChanged(changedView, visibility);
        if (!isMultiUserEnabled() && visibility==View.VISIBLE){
            setVisibility(View.INVISIBLE);
        }
    }
    //add for TEWBW-493 by liyuchong 20191231 end

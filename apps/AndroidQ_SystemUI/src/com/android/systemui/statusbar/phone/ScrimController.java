...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, OnColorsChangedListener,
    ...
    //add by wangjian for TELLB-204 20200211 start
    private boolean mNeedShowScrimView = true;
    //add by wangjian for TELLB-204 20200211 end
    ...
    public ScrimController(ScrimView scrimBehind, ScrimView scrimInFront,
        ...
        //add by wangjian for TELLB-204 20200211 start
        mNeedShowScrimView = mContext.getResources().getBoolean(R.bool.need_show_scrim);
        //add by wangjian for TELLB-204 20200211 end
    ...
    private void updateScrimColor(View scrim, float alpha, int tint) {
        ...
        //add by wangjian for TELLB-204 20200211 start
        //modify by liyuchong for TELLB-302 20200219 begin
        //if (!mNeedShowScrimView && mState != ScrimState.BOUNCER_SCRIMMED && mState != ScrimState.UNLOCKED) {
        if (!mNeedShowScrimView && (mState != ScrimState.BOUNCER_SCRIMMED && mState != ScrimState.UNLOCKED || FaceUnlockUtil.getInstance().isFaceUnlockStatusCount())) {
        //modify by liyuchong for TELLB-302 20200219 end
            alpha = 0;
        }
        //add by wangjian for TELLB-204 20200211 end

...
public interface StatusBarIconController {
    ...
    public static class TintedIconManager extends IconManager {
        ...
        protected void onIconAdded(int index, String slot, boolean blocked,
            ...
            //add by wangjian for liuhai start
            if (StatusBar.isLiuhaiSupport && (view instanceof StatusBarMobileView)) {
                ((StatusBarMobileView) view).setShouldShowMobileIcon(shouldShowMobileIcon);
            }
            //add by wangjian for liuhai end
        }
        ...
        //add by wangjian for liuhai start
        public void setMobileIconVisibility(boolean visiable) {
            shouldShowMobileIcon = visiable;
        }
        //add by wangjian for liuhai end
    }

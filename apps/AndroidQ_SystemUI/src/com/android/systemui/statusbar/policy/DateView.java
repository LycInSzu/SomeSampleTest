...
public class DateView extends TextView {
    ...
    protected void onAttachedToWindow() {
        ...
        //add by wangjian for YJSQ-658 20181201 start
        getContext().getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.DATE_FORMAT),
                false, mDateFormatObserver);
        //add by wangjian for YJSQ-658 20181201 end
    ...
    protected void updateClock() {
        if (mDateFormat == null) {
            //modify by wangjian for YJSQ-658 20181201 start
            /*

...
//add for EJQQQ-98 by liyuchong 20191120 begin
import com.android.systemui.SystemUIApplication;
//add for EJQQQ-98 by liyuchong 20191120 end
/**
...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void initDialog() {
        ...
        if (SystemUIApplication.useDgCustomUI){
            mRinger.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.rounded_bg_full_dg));
            mMain = mDialog.findViewById(R.id.main);
            mMain.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.rounded_bg_full_main_dg));
        }
        //add for EJQQQ-98 by liyuchong 20191120 end
        if (mRinger != null) {
            ...
            //add for EJQQQ-98 by liyuchong 20191120 begin
            if (SystemUIApplication.useDgCustomUI){
                mRingerIcon.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.rounded_ripple_dg));
                mRingerIcon.setImageTintList(null);
            }
            //add for EJQQQ-98 by liyuchong 20191120 end
        ...
        //add for EJQQQ-98 by liyuchong 20191120 begin
        if (SystemUIApplication.useDgCustomUI){
            mSettingsIcon.setImageResource(R.drawable.ic_volume_dialog_settings);
        }
        //add for EJQQQ-98 by liyuchong 20191120 end
        if (mRows.isEmpty()) {
            ...
            //modify for EJQQQ-98 by liyuchong 20191120 begin
            //addRow(AudioManager.STREAM_MUSIC,
            //        R.drawable.ic_volume_media, R.drawable.ic_volume_media_mute, true, true);
            if (SystemUIApplication.useDgCustomUI){
                addRow(AudioManager.STREAM_MUSIC,
                        R.drawable.ic_volume_media_dg, R.drawable.ic_volume_media_mute_dg, true, true);
            }else {
                addRow(AudioManager.STREAM_MUSIC,
                        R.drawable.ic_volume_media, R.drawable.ic_volume_media_mute, true, true);
            }
            //modify for EJQQQ-98 by liyuchong 20191120 end
            if (!AudioSystem.isSingleVolume(mContext)) {
                //modify for EJQQQ-98 by liyuchong 20191120 begin
                ...
                if (SystemUIApplication.useDgCustomUI){
                    addRow(AudioManager.STREAM_RING,
                            R.drawable.ic_volume_ringer_dg, R.drawable.ic_volume_ringer_mute_dg, true, false);
                }else {
                    addRow(AudioManager.STREAM_RING,
                            R.drawable.ic_volume_ringer, R.drawable.ic_volume_ringer_mute, true, false);
                }
    ...
    private void initRow(final VolumeRow row, final int stream, int iconRes, int iconMuteRes,
        ...
        if (SystemUIApplication.useDgCustomUI){
            row.view = mDialog.getLayoutInflater().inflate(R.layout.volume_dialog_row_dg, null);
        }else {
            row.view = mDialog.getLayoutInflater().inflate(R.layout.volume_dialog_row, null);
        }
        //modify for EJQQQ-98 by liyuchong 20191120 end
        ...
        //add for EJQQQ-98 by liyuchong 20191120 begin
        if (SystemUIApplication.useDgCustomUI && stream==AudioManager.STREAM_MUSIC){
        ...
        if (mState != null) {
            ...
            switch (mState.ringerModeInternal) {
                case AudioManager.RINGER_MODE_VIBRATE:
                    ...
                    if (SystemUIApplication.useDgCustomUI){
                        mRingerIcon.setImageResource(R.drawable.ic_volume_ringer_vibrate_dg);
                    }else {
                        mRingerIcon.setImageResource(R.drawable.ic_volume_ringer_vibrate);
                    }
                    //modify for EJQQQ-98 by liyuchong 20191120 end
                ...
                case AudioManager.RINGER_MODE_SILENT:
                    ...
                    if (SystemUIApplication.useDgCustomUI){
                        mRingerIcon.setImageResource(R.drawable.ic_volume_ringer_mute_dg);
                    }else {
                        mRingerIcon.setImageResource(R.drawable.ic_volume_ringer_mute);
                    }
                    //modify for EJQQQ-98 by liyuchong 20191120 end
                ...
                default:
                    ...
                    //modify for EJQQQ-98 by liyuchong 20191120 begin
                        ...
                        if (SystemUIApplication.useDgCustomUI){
                            mRingerIcon.setImageResource(R.drawable.ic_volume_ringer_dg);
                        }else {
                            mRingerIcon.setImageResource(R.drawable.ic_volume_ringer);
                        }
                    //modify for EJQQQ-98 by liyuchong 20191120 end
    ...
    private void updateVolumeRowTintH(VolumeRow row, boolean isActive) {
        ...
        if (tint == row.cachedTint && (!SystemUIApplication.useDgCustomUI || !isActive)) return;
        if (SystemUIApplication.useDgCustomUI) {
            row.slider.setAlpha(((float) alpha) / 255);
            if(row.iconState==Events.ICON_STATE_MUTE){
                ColorStateList color = mContext.getResources().getColorStateList(R.color.dg_volume_dialog_inactive);
                row.icon.setImageTintList(color);
            }else {
                ColorStateList color = mContext.getResources().getColorStateList(R.color.dg_volume_dialog_theme);
                row.icon.setImageTintList(color);
            }
        }else {
            row.slider.setProgressTintList(tint);

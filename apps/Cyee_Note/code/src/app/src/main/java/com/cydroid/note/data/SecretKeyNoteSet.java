 ...
 */
public class SecretKeyNoteSet extends KeyNoteSet {

    public SecretKeyNoteSet(Path path, NoteAppImpl application) {
    ...
    public synchronized void initDataSource(NoteAppImpl application) {
        ...
        mBaseSet = application.getDataManager().getMediaSet(LocalSource.LOCAL_SECRET_SET_PATH);

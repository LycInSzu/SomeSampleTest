...
import java.io.IOException;
import java.io.OutputStream;
//Chenyee <CY_Bug> <xuyongji> <20171211> modify for SW17W16A-2459 begin
import java.util.Locale;
//Chenyee <CY_Bug> <xuyongji> <20171211> modify for SW17W16A-2459 end
...
public class WriteCommandService extends Service {
    ...
    private static final String BLOCK_FILE_NAME = "/cache/recovery/block.map";
    ...
    private void addCommandFile(String strCmdLine, boolean nand_project) {
        ...
        try {
			...
			//Chenyee <CY_Bug> <xuyongji> <20180326> modify for SW17W16A-3465 begin
            if (nand_project == false) {
            	if (package_path.startsWith("/data/")) {
		            ...
		            File BLOCK_MAP = new File(BLOCK_FILE_NAME);
		            if (BLOCK_MAP.exists()) {
		                BLOCK_MAP.delete();
		                Log.i(TAG,
		                        "addCommandFile:delete existed block file");
		            }
                ...
                strCmdLine = filenameArg + localeArg;
				//Chenyee <CY_Bug> <xuyongji> <20171211> modify for SW17W16A-2459 end
            }
			//Chenyee <CY_Bug> <xuyongji> <20180326> modify for SW17W16A-3465 end

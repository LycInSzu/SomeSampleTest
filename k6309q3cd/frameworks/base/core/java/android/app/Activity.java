...
public class Activity extends ContextThemeWrapper
    ...
    protected void onResume() {
        ...
        mCalled = true;
        //prize-add for bugid 68762 -by-peisaisai-20190103-begin
        //android.util.Log.e("peisaisai","onResume() ,"+getPackageName());
        if(getPackageName().contains("com.google.android.setupwizard")){
            if(getRequestedOrientation()!=ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
                setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            }
        }
        //prize-add for bugid 68762 -by-peisaisai-20190103-end
    }

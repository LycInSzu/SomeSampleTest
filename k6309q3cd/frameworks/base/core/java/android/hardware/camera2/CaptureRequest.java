...
public final class CaptureRequest extends CameraMetadata<CaptureRequest.Key<?>>
	...
	//prize-tangan-20180920-add prize camera-begin
	/**************************************************************************************
	 **************************Third Party Algorithm Customization*************************
	 **************************************************************************************/ 
     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_ARCSOFT_HDR_MODE =
            new Key<Integer>("android.vendor.arcsofHdrMode", int.class); 
    
     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_ARCSOFT_LOWLIGHT_MODE =
            new Key<Integer>("android.vendor.arcsofLowLightMode", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_ARCSOFT_PICSELFIE_MODE =
            new Key<Integer>("android.vendor.arcsofPicSelfieMode", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_ARCSOFT_PICZOOM_MODE =
            new Key<Integer>("android.vendor.arcsofPicZoomMode", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_FOTONATION_FB_MODE =
            new Key<Integer>("android.vendor.fnFBMode", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_FOTONATION_FB_SMOOTHING_LEVEL =
            new Key<Integer>("android.vendor.fnFBSmoothingLevel", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_FOTONATION_FB_TONING_LEVEL =
            new Key<Integer>("android.vendor.fnFBToningLevel", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_FOTONATION_FB_SLIMMING_LEVEL =
            new Key<Integer>("android.vendor.fnFBSlimmingLevel", int.class);

     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_FOTONATION_FB_EYEENLARGE_LEVEL =
            new Key<Integer>("android.vendor.fnFBEyeEnlargeLevel", int.class);
	
     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_MIRROR_ENABLE =
            new Key<Integer>("android.control.flipmode", int.class);
	
     /**
     * @hide
     */
    public static final Key<Integer> VENDOR_WATERMARK_ENABLE =
            new Key<Integer>("android.vendor.watermarkEnable", int.class);

     /**
     * @hide
     */			
    public static final Key<android.util.Size> JPEG_SIZE =
            new Key<android.util.Size>("android.jpeg.size", android.util.Size.class);

    /**
     * @hide
     */
    public static final Key<Integer> VENDOR_ARCSOFT_FB_LEVEL =
            new Key<Integer>("android.vendor.arcsofFBLevel", int.class);
    /**
    * @hide
    */
    public static final Key<Integer> VENDOR_AICAMERA_ENABLE =
            new Key<Integer>("android.vendor.aicameraEnable", int.class);
			
    /**
    * @hide
    */
    public static final Key<Integer> VENDOR_SCREENFLASH_MODE =
            new Key<Integer>("android.vendor.screenflashMode", int.class);

	/**
    * @hide
    */
    public static final Key<Integer> VENDOR_UV_BOKEH_MODE =
            new Key<Integer>("android.vendor.uvBokehMode", int.class);

	/**
    * @hide
    */
    public static final Key<Integer> VENDOR_UV_BOKEH_STRENGTH =
            new Key<Integer>("android.vendor.uvBokehStrength", int.class);
	
	/**
    * @hide
    */
    public static final Key<Integer> VENDOR_UV_BOKEH_RADIUS =
            new Key<Integer>("android.vendor.uvBokehRadius", int.class);
	
	/**
    * @hide
    */
    public static final Key<android.util.Size> VENDOR_UV_BOKEH_COORDINATE =
            new Key<android.util.Size>("android.vendor.uvBokehCoordinate", android.util.Size.class);
	
	/**
     * @hide
     */			
    public static final Key<android.util.Size> VENDOR_PREVIEWSIZE =
            new Key<android.util.Size>("android.vendor.previewsize", android.util.Size.class);
	//prize-tangan-20180920-add prize camera-end

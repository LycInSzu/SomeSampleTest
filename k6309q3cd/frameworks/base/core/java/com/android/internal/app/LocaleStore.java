...
public class LocaleStore {
	...
	//prize add by liyuchong, add suggest language for condor ,20190124-begin
    private static void addSuggestedLocalesForCondor() {
        ...
        for (LocaleInfo li : sLocaleCache.values()) {
            if (strArray.contains(li.getId())) {
                li.mSuggestionFlags |= LocaleInfo.SUGGESTION_TYPE_SIM;
            }
        }
    }
	//prize add by liyuchong, add suggest language for condor ,20190124-end
    ...
    public static void fillCache(Context context) {
        ...
        for (String localeId : LocalePicker.getSupportedLocales(context)) {
            ...
            if (LocaleList.isPseudoLocale(li.getLocale())) {
                //prize zengke 20181012 67153 not cache the PseudoLocale(FAQ20045)---begin
                if (false/*isInDeveloperMode*/) {
                //prize zengke 20181012 67153 not cache the PseudoLocale(FAQ20045)---end

...
#prize zengke 20181013 delete alarms/oggNeptunium.ogg
LOCAL_PATH := frameworks/base/data/sounds

#prize-add custom boot and shut resource-zengke-20180905-begin
BOOTSHUT_DIR = frameworks/base/data/sounds
BOOTANI = bootanimation.zip
BOOTANI_EXIST := $(shell if [ -e $(BOOTSHUT_DIR)/$(BOOTANI) ]; then echo "exist"; else echo "noexist"; fi;)
ifeq ($(BOOTANI_EXIST), exist)
  PRODUCT_COPY_FILES += \
        $(BOOTSHUT_DIR)/$(BOOTANI):system/media/bootanimation.zip
endif
BOOTAUDIO = bootaudio.mp3
BOOTAUDIO_EXIST := $(shell if [ -e $(BOOTSHUT_DIR)/$(BOOTAUDIO) ]; then echo "exist"; else echo "noexist"; fi;)
ifeq ($(BOOTAUDIO_EXIST), exist)
  PRODUCT_COPY_FILES += \
        $(BOOTSHUT_DIR)/$(BOOTAUDIO):system/media/bootaudio.mp3
endif
SHUTANI = shutanimation.zip
SHUTANI_EXIST := $(shell if [ -e $(BOOTSHUT_DIR)/$(SHUTANI) ]; then echo "exist"; else echo "noexist"; fi;)
ifeq ($(SHUTANI_EXIST), exist)
  PRODUCT_COPY_FILES += \
        $(BOOTSHUT_DIR)/$(SHUTANI):system/media/shutanimation.zip
  PRODUCT_PROPERTY_OVERRIDES += persist.vendor.operator.optr=CUST
endif
SHUTAUDIO = shutaudio.mp3
SHUTAUDIO_EXIST := $(shell if [ -e $(BOOTSHUT_DIR)/$(SHUTAUDIO) ]; then echo "exist"; else echo "noexist"; fi;)
ifeq ($(SHUTAUDIO_EXIST), exist)
  PRODUCT_COPY_FILES += \
        $(BOOTSHUT_DIR)/$(SHUTAUDIO):system/media/shutaudio.mp3
endif
#prize-add custom boot and shut resource-zengke-20180905-end
#prize-add for fixbug:67902 remove the duplicate alarm ringtones by xiekui-20181109-start
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/effects/ogg/TW_Battery_caution.ogg:system/media/audio/ui/TW_Battery_caution.ogg \
    ...
    $(LOCAL_PATH)/notifications/prize_noti_bodong.ogg:system/media/audio/notifications/prize_noti_bodong.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_chandong.ogg:system/media/audio/notifications/prize_noti_chandong.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_default.ogg:system/media/audio/notifications/prize_noti_default.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_dingdong.ogg:system/media/audio/notifications/prize_noti_dingdong.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_gaoping.ogg:system/media/audio/notifications/prize_noti_gaoping.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_huixiang.ogg:system/media/audio/notifications/prize_noti_huixiang.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_jinggao.ogg:system/media/audio/notifications/prize_noti_jinggao.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_lianyi.ogg:system/media/audio/notifications/prize_noti_lianyi.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_lingling.ogg:system/media/audio/notifications/prize_noti_lingling.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_muqing.ogg:system/media/audio/notifications/prize_noti_muqing.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_qingchui.ogg:system/media/audio/notifications/prize_noti_qingchui.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_shangxingzhe.ogg:system/media/audio/notifications/prize_noti_shangxingzhe.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_shaodong.ogg:system/media/audio/notifications/prize_noti_shaodong.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_xingxing.ogg:system/media/audio/notifications/prize_noti_xingxing.ogg \
    $(LOCAL_PATH)/notifications/prize_noti_zhankai.ogg:system/media/audio/notifications/prize_noti_zhankai.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_default.ogg:system/media/audio/ringtones/prize_ring_default.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_dianpingying.ogg:system/media/audio/ringtones/prize_ring_dianpingying.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_diaoxie.ogg:system/media/audio/ringtones/prize_ring_diaoxie.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_dingding.ogg:system/media/audio/ringtones/prize_ring_dingding.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_duanchu.ogg:system/media/audio/ringtones/prize_ring_duanchu.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_jingdian.ogg:system/media/audio/ringtones/prize_ring_jingdian.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_koushao.ogg:system/media/audio/ringtones/prize_ring_koushao.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_mati.ogg:system/media/audio/ringtones/prize_ring_mati.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_qingchen.ogg:system/media/audio/ringtones/prize_ring_qingchen.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_qingchui.ogg:system/media/audio/ringtones/prize_ring_qingchui.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_tiaodong.ogg:system/media/audio/ringtones/prize_ring_tiaodong.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_wuhou.ogg:system/media/audio/ringtones/prize_ring_wuhou.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_yaowang.ogg:system/media/audio/ringtones/prize_ring_yaowang.ogg \
    $(LOCAL_PATH)/ringtones/prize_ring_yishilanbao.ogg:system/media/audio/ringtones/prize_ring_yishilanbao.ogg \
    $(LOCAL_PATH)/Alarm_Lights.ogg:system/media/audio/alarms/Alarm_Lights.ogg \
    $(LOCAL_PATH)/alarms/ogg/Classic.mp3:system/media/audio/alarms/Classic.mp3 \
    $(LOCAL_PATH)/alarms/ogg/humorous.mp3:system/media/audio/alarms/humorous.mp3 \
    $(LOCAL_PATH)/alarms/ogg/Instance.mp3:system/media/audio/alarms/Instance.mp3 \
    $(LOCAL_PATH)/alarms/ogg/Light.mp3:system/media/audio/alarms/Light.mp3 \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/effects/ogg/VideoStop_48k.ogg:system/media/audio/ui/VideoStop.ogg
#//!--
#prize add by huhuan,launcher THEME menu,20180914-start
ifeq ($(strip $(PRIZE_LAUNCHER_THEME_SUPPORT)),yes)
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,$(LOCAL_PATH)/config,system/media/config)
endif
#prize add by huhuan,launcher THEME menu,20180914-end
#prize-add for add defaulte wallpaper liyuchong 20190218 begin
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/Wallpaper.jpg:system/media/gn_resources/DefaultTheme/Wallpaper.jpg \
	$(LOCAL_PATH)/com.android.notepads_com.android.notepad.NotePadActivity.png:system/media/gn_resources/DefaultTheme/com.android.notepads_com.android.notepad.NotePadActivity.png
#prize-add for add defaulte wallpaper liyuchong 20190218 end

...
public class VibratorService extends IVibratorService.Stub
	...
	// prize_70365_improve vibrate strength while unlock with wrong fingerprint_modified_liyuchong_20190104_start
    private static final long[] DOUBLE_CLICK_EFFECT_FALLBACK_TIMINGS = { 0, 40, 100, 40 };
	// prize_70365_improve vibrate strength while unlock with wrong fingerprint_modified_liyuchong_20190104_end
            ...
            if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
                synchronized (mLock) {
                    ...
                    if (mCurrentVibration != null
							...
							//prize modified by liyuchong,MTK_CMASReceiver vibrate function for Condor, 2019.01.24-begin
							String callingApp = mCurrentVibration.opPkg;
							Slog.e(TAG, "callingApp: " + callingApp );
							if(!("com.mediatek.cellbroadcastreceiver".equals(callingApp))) {
								        doCancelVibrateLocked();
							}
							//prize modified by liyuchong,MTK_CMASReceiver vibrate function for Condor, 2019.01.24-end
                    }
                }
            }
        }

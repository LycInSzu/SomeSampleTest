...
public class AudioService extends IAudioService.Stub
   ...
   /** Maximum volume index values for audio streams */
	...
	//prize add by liyuchong,MTK_CMASReceiver for Condor, 2019.01.24-begin
    private static boolean mUseFixedAlertVolume = false; 
	//prize add by liyuchong,MTK_CMASReceiver for Condor, 2019.01.24-end
    /**
   ...
   protected static final int DEFAULT_VOL_STREAM_NO_PLAYBACK = AudioSystem.STREAM_MUSIC;
    ...
    public AudioService(Context context) {
        ...
        //pss del for STREAM_MUSIC -20180917-beigin
        /*else {
        ...
        //pss del for STREAM_MUSIC -20180917-end
        ...
        //pss del for STREAM_ALARM -20180917-beigin
        /*else {
        ...
        //pss del for STREAM_ALARM -20180917-end
	...
	//prize add by liyuchong,MTK_CMASReceiver for Condor, 2019.01.24-end
		...
		//prize add by liyuchong,MTK_CMASReceiver for Condor, 2019.01.24-begin
        if ((!"com.mediatek.cellbroadcastreceiver".equals(callingPackage)) &&(!volumeAdjustmentAllowedByDnd(streamTypeAlias, flags))) {
            return;
        }
		//prize add by liyuchong,MTK_CMASReceiver for Condor, 2019.01.24-end
        synchronized (mSafeMediaVolumeState) {

...
public class CaptureSurface {
    ...
    //prize-huangzhanbin-20181010-add prize camera-start
    public int getWidth() {
        synchronized (mImageReaderSync) {
            if (mCaptureImageReader != null) {
                return mCaptureImageReader.getWidth();
            }
            return 0;
        }
    }
    ...
    public int getHeight() {
        synchronized (mImageReaderSync) {
            if (mCaptureImageReader != null) {
                return mCaptureImageReader.getHeight();
            }
            return 0;
        }
    }
    ...
    //prize-huangzhanbin-20181010-add prize camera-end

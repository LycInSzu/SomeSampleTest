...
public class GifDevice2Controller extends Device2Controller implements IGifDeviceController ,
    ...
    public GifDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context){
    ...
    private void initSettings() throws CameraAccessException {
        ...
        Relation relation = GifRestriction.getRestriction().getRelation("on",
                false);
/*

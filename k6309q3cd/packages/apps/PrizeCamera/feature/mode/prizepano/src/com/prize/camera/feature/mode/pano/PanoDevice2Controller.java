...
public class PanoDevice2Controller extends Device2Controller implements IPanoDeviceController ,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(com.prize.camera.feature.mode.pano.PanoDevice2Controller.class.getSimpleName());
    ...
    private IPanoDeviceController.PreviewCallback mPreviewCallback;
    /**
    ...
    public PanoDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context){
    ...
    private void initSettings() throws CameraAccessException {
        ...
        Relation relation = PanoRestriction.getRestriction().getRelation("on",
                false);
    ...
    public void setPreviewCallback(IPanoDeviceController.PreviewCallback callback){

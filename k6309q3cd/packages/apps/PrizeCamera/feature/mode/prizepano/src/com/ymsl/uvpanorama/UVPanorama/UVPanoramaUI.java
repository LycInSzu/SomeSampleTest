...
public class UVPanoramaUI {
    ...
    private static final float     mScale     = 0.1672f;
    ...
    public void initSamllPreview(Context context) {
        mUVPanoramaInterface = new UVPanoramaInterface(context);
    ...
    public void setThumbPreviewInteractive(Bitmap rightArrow, Bitmap leftArrow,
                                           IUVPanoCallback iuvPanoCallback,
                                           UVPanoramaInterface.PanoPictureCallback panoPictureCallback) {
        if (null != mUVPanoramaInterface) {
            mUVPanoramaInterface.setThumbPreviewInteractive(rightArrow, leftArrow, iuvPanoCallback, panoPictureCallback);
        } else {

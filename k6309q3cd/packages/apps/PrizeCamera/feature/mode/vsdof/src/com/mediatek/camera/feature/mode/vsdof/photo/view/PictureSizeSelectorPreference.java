 ...
 */
public class PictureSizeSelectorPreference extends PrizePreferenceFragment { //prize-tangan-add prize camera-begin
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        tvTitle.setText(R.string.sdof_picture_size_title);
		//prize-tangan-add prize camera-end

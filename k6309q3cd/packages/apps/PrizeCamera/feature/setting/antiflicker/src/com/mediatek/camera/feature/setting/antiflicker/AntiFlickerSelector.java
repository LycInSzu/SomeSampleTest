...
public class AntiFlickerSelector extends PrizePreferenceFragment {//prize-tangan-add prize camera-begin
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.pref_camera_antibanding_title);
		//prize-tangan-add prize camera-end

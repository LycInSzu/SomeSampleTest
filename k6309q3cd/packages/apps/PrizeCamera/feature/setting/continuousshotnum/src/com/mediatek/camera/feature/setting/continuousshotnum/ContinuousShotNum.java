...
public class ContinuousShotNum extends SettingBase{
    ...
    public void addViewEntry() {
        if(ContinuousShotNumView == null){
            ContinuousShotNumView = new ContinuousShotNumView();
        }
        ContinuousShotNumView.setOnValueChangeListener(mValueChangeListener);
    ...
    private IContinuousShotNumViewListener.OnValueChangeListener mValueChangeListener
            = new IContinuousShotNumViewListener.OnValueChangeListener() {
        @Override
    ...
    private void initSettingValue() {
        ...
        String valueInStore = mDataStore.getValue(getKey(),
                IContinuousShotNumViewListener.TWENTY_SHOTS, getStoreScope());

...
class HdrRestriction {
    ...
    static {
        ...
        sRelationGroup.setBodyKeys("key_flash, key_scene_mode, key_dng, key_continuous_shot" +
                ...
                ",key_brightness,key_contrast,key_hue,key_saturation,key_sharpness,key_ai");//prize-modify-huangpengfei-2019-01-25
        sRelationGroup.addRelation(
                new Relation.Builder("key_hdr", "on")
                        ...
                        .addBody("key_ai", "off", "off,on")//prize-add-huangpengfei-2019-01-25
                        .build());
        sRelationGroup.addRelation(
                new Relation.Builder("key_hdr", "auto")
                        ...
                        .addBody("key_ai", "off", "off,on")//prize-add-huangpengfei-2019-01-25
                        .build());
        /*prize-modify-bugid:66685 the continuous  can not open after hdr off -xiaoping-20181015-start */
        sRelationGroup.addRelation(
                new Relation.Builder("key_hdr","off")
                        .addBody("key_continuous_shot", "on", "on")
                        .build()
        );
        /*prize-modify-bugid:66685 the continuous  can not open after hdr off -xiaoping-20181015-end */
    }

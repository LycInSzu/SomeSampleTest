...
public class MirrorSettingView implements ICameraSettingView {
    ...
    public interface OnMirrorClickListener {
         ...
         */
        void onMirrorClicked(boolean checked);
    }
     ...
     */
    public MirrorSettingView(String key) {
        mKey = key;
    }

    @Override
    public void loadView(PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.mirror_preference);
     ...
     *
     * @param listener The instance of {@link OnMirrorClickListener}.
     */
    public void setMirrorOnClickListener(OnMirrorClickListener listener) {
        mListener = listener;
    }

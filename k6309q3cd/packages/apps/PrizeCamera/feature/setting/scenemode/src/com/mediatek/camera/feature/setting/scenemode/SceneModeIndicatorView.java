...
public class SceneModeIndicatorView {
    ...
    public SceneModeIndicatorView(Activity activity) {
        ...
        TypedArray array = activity.getResources()
                .obtainTypedArray(R.array./*scene_mode_indicators*/prize_scene_mode_indicators);//prize-change-huangpengfei-20181026
        int n = array.length();
    ...
    public void updateIndicator(String scene) {
        LogHelper.d(TAG,"[setEnabled]  scene = " + scene);
    ...
    private class MainHandler extends Handler {
        ...
        private void updateIndicator(String scene) {
            LogHelper.d(TAG, "[updateIndicator], scene:" + scene + "  mOriginalEntryValues = " + mOriginalEntryValues +
            "   mOriginalIndicator = " + mOriginalIndicator);
            int index = -1;

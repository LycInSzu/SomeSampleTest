...
public class SceneModeSettingView implements ICameraSettingView,
    ...
    public void onItemClick(String value) {
        LogHelper.d(TAG,"[onItemClick]  value = " + value);
        setValue(value);
        if (mListener != null) {
    ...
    public SceneModeSettingView(Activity activity, String key) {
        ...
        TypedArray array = mActivity.getResources().obtainTypedArray(R.array.prize_scene_mode_icons);//prize-tangan-add prize camera-begin
        int n = array.length();
    ...
    public void refreshView() {
        LogHelper.d(TAG,"[refreshView]  mEnabled = " + mEnabled);
        if (mPreference != null) {
            mPreference.setSummary(mSummary);
            mPreference.setEnabled(mEnabled);
        }

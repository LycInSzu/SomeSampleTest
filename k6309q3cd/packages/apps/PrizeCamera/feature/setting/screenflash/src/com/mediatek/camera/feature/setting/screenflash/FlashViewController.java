...
public class FlashViewController {
    ...
    private final FlashOnTouchListerer mFlashOnTouchListerer;
    ...
    private int mFlashIconRight;///prize-add-huangpengfei-2019-03-06
    ...
    public FlashViewController(ScreenFlash flash, IApp app) {
        ...
        mFlashOnTouchListerer = new FlashOnTouchListerer();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case FLASH_VIEW_ADD_QUICK_SWITCH:
                    mApp.getAppUi().addToQuickSwitcher(mFlashEntryView, SCREEN_FLASH_PRIORITY); //LAVA_EDIT modified by jiangym
...
//                    updateFlashIndicator(mFlash.getValue());
                ...
                case FLASH_VIEW_HIDE_CHOICE_VIEW:
                    if (mPrizeFlashMenuContainer != null && mPrizeFlashMenuContainer.isShown()) {
    ...
    private void prizeInitializeFlashChoiceView() {
        if (mOptionLayout == null) {
            ...
            layoutParams.leftMargin = mFlashIconRight;
            mPrizeFlashMenuContainer.setLayoutParams(layoutParams);
            /*prize-add-huangpengfei-2019-03-06-end*/
            mPrizeFlashMenuContainer.setOnAnimationListener(new PrizeFlashMenuContainer.OnHideAnimationListener() {
                @Override
                public void onHideAnimationEnd() {
                    LogHelper.d(TAG, "[onHideAnimationEnd] mFlashEntryView.setClickable(true) ");
                    mFlashEntryView.setClickable(true);
    ...
    private void showFlashMenuContainer() {
        LogHelper.d(TAG, "[showFlashMenuContainer] mFlashEntryView.setClickable(false)");
        mFlashEntryView.setClickable(false);
    ...
    private void hideFlashMenuContainer() {
        LogHelper.d(TAG, "[hideFlashMenuContainer] mFlashEntryView.setClickable(false) ");
        mFlashEntryView.setClickable(false);
    ...
    private final View.OnClickListener mFlashEntryListener = new View.OnClickListener() {
        public void onClick(View view) {
            ...
            //Lava Close the settings interface add by wzj 2018-10-27 start
            //mApp.getAppUi().controlSetting(false,true);
            //Lava Close the settings interface add by wzj 2018-10-27 end
            if (mFlash.getEntryValues().size() > FLASH_ENTRY_LIST_SWITCH_SIZE) {
                //initializeFlashChoiceView();
                prizeInitializeFlashChoiceView();
                updateChoiceView();
    ...
    class FlashOnTouchListerer implements IApp.OnTouchListener{

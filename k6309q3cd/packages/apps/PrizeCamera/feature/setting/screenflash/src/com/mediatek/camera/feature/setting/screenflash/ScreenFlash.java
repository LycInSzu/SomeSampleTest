...
public class ScreenFlash extends SettingBase {
    ...
    public void init(IApp app,
        ...
        // @}
        mAppUi.registerGestureListener(mOnGestureListener, SCREEN_FLASH_PRIORITY); //Lava listening Click on the blank area to close option add by wzj 2018-10-30
    ...
    public void unInit() {
        ...
        mFlashViewController.updateFlashIndicator(FLASH_OFF_VALUE);
        mAppUi.unregisterGestureListener(mOnGestureListener);//Lava Cancel listening Click on the blank area to close option add by wzj 2018-10-30
...
//Lava listening Click on the blank area to close option add by wzj 2018-10-30 start
    ...
    //Lava listening Click on the blank area to close option add by wzj 2018-10-30 end

    ...
    public void showReviewUI(Bitmap bitmap) {
        ...
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                /*prize-add-huangpengfei-20190305-start*/
                mApp.getAppUi().setUIVisibility(IAppUi.CAMERA_SWITCHER,View.GONE);
                /*prize-add-huangpengfei-20190305-end*/

                if (mBitmap != null) {
                    mReviewImage = (ImageView) mReviewRootView.findViewById(R.id.review_image);
                    /*prize-modify-bugid:70976 proactive camera appears twice mirrored-xiaoping-20190214-start*/
                    FrameLayout.LayoutParams reviewImageLayoutParamsparams =
                            (FrameLayout.LayoutParams) mReviewImage.getLayoutParams();
                    if (Math.abs(mApp.getAppUi().getPreviewFrameLayout().getRadio() - 1.333) < 0.1) {
                        reviewImageLayoutParamsparams.bottomMargin += mApp.getAppUi().getPreviewFrameLayout().getBottomMarginfor43() *2;
                    } else {
                        reviewImageLayoutParamsparams.bottomMargin = 0;
                    }
                    mReviewImage.setLayoutParams(reviewImageLayoutParamsparams);
                    mReviewImage.setImageBitmap(mBitmap);
                    mReviewImage.setVisibility(View.VISIBLE);
                } else if (mReviewImage != null) {
                    mReviewImage.setVisibility(View.INVISIBLE);
                }
                /*prize-modify-bugid:70976 proactive camera appears twice mirrored-xiaoping-20190214-end*/
            }
        });
    ...
    public void hideReviewUI() {
        ...
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                /*prize-add-huangpengfei-20190305-start*/
                mApp.getAppUi().setUIVisibility(IAppUi.CAMERA_SWITCHER,View.VISIBLE);
                /*prize-add-huangpengfei-20190305-end*/
            }
        });
    }

...
public class IntentPhotoUi implements IIntentPhotoUi {
    ...
    /*prize-modify-bugid:70751 The contact call camera takes the last picture without flash effect-xiaoping-20190116-start*/
    private Bitmap mBitmap;
    /*prize-modify-bugid:70751 The contact call camera takes the last picture without flash effect-xiaoping-20190116-end*/
    ...
    public void onPictureReceived(byte[] data) {
        ...
        mIsShown = true;
        /*prize-modify-bugid:70751 and 70976 The contact call camera takes the last picture without flash effect-xiaoping-20190116-start*/
        if (mIAppUi.getCameraId() == 1) {
            mIReviewUI.showReviewUI(null);
        } else {
            mBitmap = BitmapFactory.decodeByteArray(data, 0, data.length);
            mIReviewUI.showReviewUI(mBitmap);
        }
        /*prize-modify-bugid:70751 and 70976 The contact call camera takes the last picture without flash effect-xiaoping-20190116-end*/
    }

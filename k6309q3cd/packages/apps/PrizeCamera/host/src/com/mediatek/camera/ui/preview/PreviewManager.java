...
public class PreviewManager {
        ...
        public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft,
            ...
            mPreviewFrameLayout.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mPreviewFrameLayout.setScreenPixHeight(((CameraAppUI)mApp.getAppUi()).getScreenPixHeight());
    ...
    public double getPreviewAspectRatio() {
        return mPreviewController.getPreviewAspectRatio();
    }
    ...
    public Bitmap getTextureBitmap(int width, int height){
        if(null != mPreviewController){
            return mPreviewController.getTextureBitmap(width, height);
        }
        return  null;
    }
    ...
    public TextureView getSurfaceTextureView(){
        if(null != mPreviewController){
            return mPreviewController.getSurfaceTextureView();
        }
        return  null;
    }
    ...
    public void setTexutreUpdateCallback(IAppUi.TexutreUpdateCallback callback){
        if(null != mPreviewController){
            mPreviewController.setTexutreUpdateCallback(callback);
        }
    }
}

...
class TextureViewController implements IController {
    ...
    public void updatePreviewSize(int width, int height, ISurfaceStatusListener listener) {
        ...
        LogHelper.d(TAG, "[updatePreviewSize] ratio = " + ratio + "  mPreviewAspectRatio = " + mPreviewAspectRatio);
        ...
        mPreviewAspectRatio = (double) Math.max(width, height)
                / Math.min(width, height);
        LogHelper.d(TAG, "[updatePreviewSize] mTextureView = " + mTextureView);
    ...
    private void attachTextureView(ISurfaceStatusListener listener) { 
        LogHelper.d(TAG, "[attachTextureView]  mLastPreviewContainer = " + mLastPreviewContainer);
    ...
    private class SurfaceChangeCallback implements TextureView.SurfaceTextureListener {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            if(null != mTextureUpdateCallback){
                mTextureUpdateCallback.onTextureUpdated(surface);
            }
        }
    }
    ...
    public Bitmap getTextureBitmap(int width, int height){
    ...
    public void setTexutreUpdateCallback(IAppUi.TexutreUpdateCallback callback){
        mTextureUpdateCallback = callback;
    }
}

...
void jni_init222(JNIEnv *env, jobject obj, jint width, jint height){
    
    
}

jboolean jni_init(JNIEnv *env, jobject obj, jint width, jint height) {

...
//prize add by tianhuiju notification 20180921 start
import com.android.soundrecorder.SoundRecorder;
//prize add by tianhuiju notification 20180921 end
...
//            }
    ...
    private void receiveBroadcast(Context context, Intent intent) {
        ...
        if (Intent.ACTION_MEDIA_EJECT.equals(action)
            ...
            storeRecordParamsSettings();
            //prize add by xiarui for bug72254 start
            if (mCurrentState == STATE_RECORDING || mCurrentState == STATE_PAUSE_RECORDING){
                stopRecordingAsync();
                saveRecordAsync();
            }
            //prize add by xiarui for bug72254 end
    ...
    private void showNotification(Context context) {
        ...
        case STATE_PAUSE_RECORDING:
            //prize modify zengke 20180919 66847  begin
            intent = new Intent("com.android.soundrecorder.SoundRecorder");
            //prize modify zengke 20180919 66847  end
            break;
		...
		//prize modify by tianhuiju notification 20180921 start
        //Notification notification = new Notification();
        Notification notification = new Notification.Builder(SoundRecorderService.this,SoundRecorder.SOUNDRECORDER_NOTIFICATION_CHANNEL).build();
		//prize modify by tianhuiju notification 20180921 end

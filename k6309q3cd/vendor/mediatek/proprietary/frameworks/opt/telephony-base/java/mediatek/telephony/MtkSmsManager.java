...
public final class MtkSmsManager {
    ...
    //prize modified by xiekui, show the sim dialog to select when sending sms, 20190328-start
    public static boolean checkSimPickActivityNeeded(boolean needed) {
        //return false;
        return true;
    }
    //prize modified by xiekui, show the sim dialog to select when sending sms, 20190328-end
}

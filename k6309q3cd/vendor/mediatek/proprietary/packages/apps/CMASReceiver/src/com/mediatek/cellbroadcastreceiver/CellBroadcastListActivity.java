...
public class CellBroadcastListActivity extends ListActivity {
    ...
    private static final int MENU_LANGUAGE_SETTING     = 3;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_LANGUAGE_SETTING, 0, R.string.menu_language_settings).setIcon(
                android.R.drawable.ic_menu_preferences);
    ...
    private boolean setLangauge() {
        ...
        return MtkSmsManager.getDefault()
                    .setCellBroadcastLang(langList.toString());
    }

    private void updateLanguagesFromModemConfig() {

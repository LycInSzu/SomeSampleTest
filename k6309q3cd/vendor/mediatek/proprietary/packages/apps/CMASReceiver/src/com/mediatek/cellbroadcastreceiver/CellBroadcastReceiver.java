...
//prize add by liyuchong, CMAS crash by add more user( bug 71456 ),20190220-begin
import android.os.UserManager;
//prize add by liyuchong, CMAS crash by add more user( bug 71456 ),20190220-end
...
//                       CheckBoxAndSettingsPreference.KEY_ENABLE_CMAS_TEST_ALERTS, enable).apply();
	...
	//prize add by liyuchong, CMAS crash by add more user( bug 71456 ),20190220-begin
        boolean  isAdmin = ((UserManager)context.getSystemService(Context.USER_SERVICE)).isAdminUser();
        if (isAdmin) {

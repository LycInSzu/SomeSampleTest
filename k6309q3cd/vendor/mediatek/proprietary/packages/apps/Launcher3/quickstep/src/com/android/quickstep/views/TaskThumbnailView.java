...
public class TaskThumbnailView extends View {
    ...
    private void updateThumbnailMatrix() {
        ...
        if (mBitmapShader != null && mThumbnailData != null) {
			...
			//prize modify by lishilun,fix 69787,modify draw background condition to avoid exception,20181218-start
			//if (Math.round(bitmapHeight) < getMeasuredHeight()) {
            if (Math.round(bitmapHeight) + 5 < getMeasuredHeight()) {
			//prize modify by lishilun,fix 69787,modify draw background condition to avoid exception,20181218-end

...
public class DeviceProfile {
    ...
    private void adjustToHideWorkspaceLabels() {
		...
		//prize add by zhouerlong fenping 20190306 begin
		...
		//prize add by zhouerlong fenping 20190306 end
    }
    ...
    private void updateIconSize(float scale, Resources res, DisplayMetrics dm) {
        ...
        iconTextSizePx = (int) (Utilities.pxFromDp(inv.iconTextSize, dm) * scale); //prize-modify by caoshaowei-modify pxFromSp to xFromDp
    ...
    private void updateFolderCellSize(float scale, DisplayMetrics dm, Resources res) {
		...
		//prize modified by liyuchong, change app name shown in folder to two lines , 20190305-begin
        folderCellHeightPx = folderChildIconSizePx + 2 * cellPaddingY + 2 * textHeight;
		//prize modified by liyuchong, change app name shown in folder to two lines , 20190305-end
    ...
    public Point getCellSize() {
        ...
        if( isVerticalBarLayout()) {
            ...
            result.y = calculateCellWidth(availableWidthPx - padding.x
                    - cellLayoutPaddingLeftRightPx * 2, inv.numColumns);
            result.x = calculateCellHeight(availableHeightPx - padding.y
                    - cellLayoutBottomPaddingPx, inv.numRows);
        }
		//prize add by zhouerlong fenping 20190306 end
    ...
    private void updateWorkspacePadding() {
        ...
        if (isVerticalBarLayout()) {
		   ...
		   //prize add by zhouerlong  top  20190320 begin


            int paddingBottom = hotseatBarSizePx-3*edgeMarginPx;
            if(isMultiWindowMode) {
                 paddingBottom = hotseatBarSizePx + verticalDragHandleSizePx;
            }
		   //prize add by zhouerlong  top  20190320 begin
            if (isTablet) {

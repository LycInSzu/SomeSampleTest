...
public class HardwareInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        setText(content, R.id.model_label, R.id.model_value,
                mExt.customeModelInfo(DeviceModelPreferenceController.getCondorDeviceModel()));
		//prize modified by liyuchong, show model name for condor in about phone,20190124-end
        /// @}

...
//prize add by liyuchong, for password out of attempts time waite string of Arabic as custom required,20190327-begin
import java.util.Locale;
//prize add by liyuchong, for password out of attempts time waite string of Arabic as custom required,20190327-end
/**
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (savedInstanceState == null) {
                ...
                if (!mFrp && !mLockPatternUtils.isLockPatternEnabled(mEffectiveUserId)) {
                    //prize-add for fixbug:68678 by xiekui-20181123-line
        ...
        private void handleAttemptLockout(long elapsedRealtimeDeadline) {
            ...
            mCountdownTimer = new CountDownTimer(
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    //prize modified by liyuchong, change the duriation translation as custom request ,20190327-begin
                    if (Locale.getDefault().getLanguage() != null && Locale.getDefault().getLanguage().trim().equals("ar")) {
                        StringBuilder tempDuration = new StringBuilder();

                        if (secondsCountdown==1) {
                            tempDuration.append(getString(
                                    R.string.lockpattern_too_many_failed_confirmation_attempts_for_condor,
                                    secondsCountdown)).append(getContext().getResources().getString(R.string.duration_second_for_condor_1));
                        } else if (secondsCountdown==2){
                            tempDuration.append(getString(
                                    R.string.lockpattern_too_many_failed_confirmation_attempts_for_condor,
                                    secondsCountdown)).append(getContext().getResources().getString(R.string.duration_second_for_condor_2));
                        }else if (secondsCountdown>=3 && secondsCountdown<=10){
                            tempDuration.append(getString(
                                    R.string.lockpattern_too_many_failed_confirmation_attempts_for_condor,
                                    secondsCountdown)).append(getContext().getResources().getString(R.string.duration_second_for_condor_3_10));
                        }else {
                            tempDuration.append(getString(
                                    R.string.lockpattern_too_many_failed_confirmation_attempts_for_condor,
                                    secondsCountdown)).append(getContext().getResources().getString(R.string.duration_second_for_condor_11_30));
                        }

                        mErrorTextView.setText(tempDuration+"");
                    ...
                    //prize modified by liyuchong, change the duriation translation as custom request ,20190327-end
                }

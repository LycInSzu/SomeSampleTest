...
public class MultiShrinkScroller extends FrameLayout {
    ...
    public void setTitle(String title, boolean isPhoneNumber) {
		...
		//prize modified by liyuchong, modify phone number show order in arabic language ,20190124-begin
        if (isPhoneNumber||needLtrDirection(title)) {
            mLargeTextView.setTextDirection(View.TEXT_DIRECTION_LTR);
        }
		//prize modified by liyuchong, modify phone number show order in arabic language ,20190124-end

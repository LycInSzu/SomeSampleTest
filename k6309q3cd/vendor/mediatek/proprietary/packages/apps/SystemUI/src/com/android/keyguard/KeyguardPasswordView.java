...
public class KeyguardPasswordView extends KeyguardAbsKeyInputView
    ...
    protected void resetState() {
        ...
        if (wasDisabled) {
            //prize delete for bugid 67873 by liufan-2018-12-1-start
            //mImm.showSoftInput(mPasswordEntry, InputMethodManager.SHOW_IMPLICIT);
            //prize delete for bugid 67873 by liufan-2018-12-1-end
        }
    }
    ...
    //prize-yuyulong-20180908 lock password failed attempts
    //return R.string.kg_wrong_password;
    return R.string.kg_wrong_Password_failed_attempts_countdown;
    }

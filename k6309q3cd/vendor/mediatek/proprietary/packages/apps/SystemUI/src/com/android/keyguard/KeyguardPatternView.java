...
public class KeyguardPatternView extends LinearLayout implements KeyguardSecurityView,
    ...
    private boolean wrong_pattern_flag = false;
    ...
    private class UnlockPatternListener implements LockPatternView.OnPatternListener {
        ...
        public void onPatternDetected(final List<LockPatternView.Cell> pattern) {
            ...
            if (pattern.size() < LockPatternUtils.MIN_PATTERN_REGISTER_FAIL) {
		        wrong_pattern_flag = true;//prize-yuyulong-20180912 lock password failed attempts			
                mLockPatternView.enableInput();
                ...
                if (timeoutMs == 0) {
                    ...
                    if(wrong_pattern_flag){
	                    ...
	                    mSecurityMessageDisplay.formatMessage(
	                        R.string.kg_wrong_pattern_failed_attempts_countdown, remaincount);
	                    }else{
	                        mSecurityMessageDisplay.setMessage(R.string.kg_wrong_pattern);
	                    }
				    }

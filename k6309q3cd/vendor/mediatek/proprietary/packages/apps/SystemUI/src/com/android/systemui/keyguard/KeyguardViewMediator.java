...
//prize add by xiarui PRIZE_FACE_ID 2019-09-06 start
import com.mediatek.common.prizeoption.PrizeOption;
//prize add by xiarui PRIZE_FACE_ID 2019-09-06 end
...
public class KeyguardViewMediator extends SystemUI {
            ...
            switch (simState) {
                ...
                case ABSENT:
                    ...
                    synchronized (KeyguardViewMediator.this) {
                        ...
                        //prize deleted by liufan, bugid:72673-2019-3-22-start
                        /*if (simState == ABSENT) {
    ...
    private void handleKeyguardDone() {
        ...
        // M: MTK FaceUnlock support
        // Clear recognize record after keyguard done.
        mUpdateMonitor.clearFaceRecognized();
    ...
    private void handleHide() {
        ...
        synchronized (KeyguardViewMediator.this) {
            ...
            //prize add by xiarui stop face unlock 2018-09-05 start
            if (PrizeOption.PRIZE_FACE_ID) {
                mUpdateMonitor.stopFaceUnlock();
            }
            //prize add by xiarui stop face unlock 2018-09-05 end
    ...
    //prize add by xiarui PRIZE_FACE_ID 2018-09-05 start
    public void nofityPowerKeyPower(boolean interactive) {
        mUpdateMonitor.nofityPowerKeyPower(interactive);
    }
    //prize add by xiarui PRIZE_FACE_ID 2018-09-05 end
    ...
    private boolean isAllowShowVirtualKey() {
        //prize add by xiarui for bug71184 2019-01-29 start
        //boolean isAllow = (mState == StatusBarState.KEYGUARD) && !mStatusBarKeyguardViewManager.isBouncerShowing();
        boolean isAllow = (mState == StatusBarState.KEYGUARD || mState == StatusBarState.SHADE_LOCKED) && !mStatusBarKeyguardViewManager.isBouncerShowing();
        //prize add by xiarui for bug71184 2019-01-29 end
        return !isAllow;
    }

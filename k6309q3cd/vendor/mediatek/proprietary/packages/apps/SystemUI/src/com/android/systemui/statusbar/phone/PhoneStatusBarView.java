...
public class PhoneStatusBarView extends PanelBar {
    ...
    public PhoneStatusBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
// prize add by liyuchong, fix status bar layout orientation for condor ,20190124-begin
            setLayoutDirection(LAYOUT_DIRECTION_LTR);
// prize add by liyuchong, fix status bar layout orientation for condor ,20190124-end

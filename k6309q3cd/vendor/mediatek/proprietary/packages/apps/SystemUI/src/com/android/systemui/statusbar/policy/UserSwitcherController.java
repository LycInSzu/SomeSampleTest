...
public class UserSwitcherController {
    ...
    public static abstract class BaseUserAdapter extends BaseAdapter {
        ...
        public Drawable getDrawable(Context context, UserRecord item) {
            if (item.isAddUser) {
                //prize modify by xiarui 2018-10-19 start
                //return context.getDrawable(R.drawable.ic_add_circle_qs);
                Drawable addIcon = context.getDrawable(R.drawable.ic_add_circle_qs);
                //addIcon.setColorFilter(Utils.getColorAttr(context, android.R.attr.colorBackground/*colorForeground*/),
                //        Mode.SRC_IN);
                addIcon.setColorFilter(0xffcdcdcd, Mode.SRC_IN);//prize modified by liufan-bugid:72579-2019-3-26
                return addIcon;
                //prize modify by xiarui 2018-10-19 end
            }
            Drawable icon = UserIcons.getDefaultUserIcon(
                    context.getResources(), item.resolveId(), /* light= */ false);
            if (item.isGuest) {
                //prize modify by xiarui colorForeground to colorBackground 2018-10-19 start
                //icon.setColorFilter(Utils.getColorAttr(context, android.R.attr.colorBackground/*colorForeground*/),
                //        Mode.SRC_IN);
                icon.setColorFilter(0xffcdcdcd, Mode.SRC_IN);//prize modified by liufan-bugid:72579-2019-3-26
                //prize modify by xiarui colorForeground to colorBackground 2018-10-19 end
            }
            return icon;
        }
